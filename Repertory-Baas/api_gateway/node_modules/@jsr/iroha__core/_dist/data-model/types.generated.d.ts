 ...
 */ export declare const TriggerExecutionFail: lib.CodecContainer<TriggerExecutionFail> & {
  MaxDepthExceeded: lib.VariantUnit<'MaxDepthExceeded'>;
};
/**
 * Enumeration (discriminated union). Represented as one of the following variants:
 * 
 ...
 */ export declare const TransactionRejectionReason: lib.CodecContainer<TransactionRejectionReason> & {
  ...
  TriggerExecution: {
    MaxDepthExceeded: lib.Variant<'TriggerExecution', lib.VariantUnit<'MaxDepthExceeded'>>;
  };
};
/**
 * Enumeration (discriminated union). Represented as one of the following variants:
 ...
 */ export declare const TransactionStatus: lib.CodecContainer<TransactionStatus> & {
  ...
  Rejected: {
    ...
    TriggerExecution: {
      MaxDepthExceeded: lib.Variant<'Rejected', lib.Variant<'TriggerExecution', lib.VariantUnit<'MaxDepthExceeded'>>>;
    };
  };
};
/**
 ...
 */ export interface BlockHeader {
  ...
  merkleRoot: lib.Option<lib.Hash>;
  resultMerkleRoot: lib.Option<lib.Hash>;
...
export declare const ExecutionStep: lib.CodecContainer<ExecutionStep>;
/**
 * Structure with named fields.
 */ export interface TimeTriggerEntrypoint {
  id: TriggerId;
...
/**
 * Codec of the structure.
 */ export declare const TimeTriggerEntrypoint: lib.CodecContainer<TimeTriggerEntrypoint>;
export type MerkleTree = lib.Vec<lib.Option<lib.Hash>>;
export declare const MerkleTree: lib.CodecContainer<MerkleTree>;
/**
 * Structure with named fields.
 */ export interface DataTriggerStep {
  id: TriggerId;
  instructions: ExecutionStep;
}
/**
 * Codec of the structure.
 */ export declare const DataTriggerStep: lib.CodecContainer<DataTriggerStep>;
/**
 * Enumeration (discriminated union). Represented as one of the following variants:
 * 
 * - `Ok`
 ...
 */ export declare const TransactionResult: lib.CodecContainer<TransactionResult> & {
  Ok: <const T extends lib.Vec<DataTriggerStep>>(value: T) => lib.Variant<'Ok', T>;
  Err: {
    AccountDoesNotExist: {
      Asset: <const T extends lib.AssetId>(value: T) => lib.Variant<'Err', lib.Variant<'AccountDoesNotExist', lib.Variant<'Asset', T>>>;
      AssetDefinition: <const T extends lib.AssetDefinitionId>(value: T) => lib.Variant<'Err', lib.Variant<'AccountDoesNotExist', lib.Variant<'AssetDefinition', T>>>;
      Nft: <const T extends lib.NftId>(value: T) => lib.Variant<'Err', lib.Variant<'AccountDoesNotExist', lib.Variant<'Nft', T>>>;
      Account: <const T extends lib.AccountId>(value: T) => lib.Variant<'Err', lib.Variant<'AccountDoesNotExist', lib.Variant<'Account', T>>>;
      Domain: <const T extends lib.DomainId>(value: T) => lib.Variant<'Err', lib.Variant<'AccountDoesNotExist', lib.Variant<'Domain', T>>>;
      MetadataKey: <const T extends lib.Name>(value: T) => lib.Variant<'Err', lib.Variant<'AccountDoesNotExist', lib.Variant<'MetadataKey', T>>>;
      Block: <const T extends lib.Hash>(value: T) => lib.Variant<'Err', lib.Variant<'AccountDoesNotExist', lib.Variant<'Block', T>>>;
      Transaction: <const T extends lib.Hash>(value: T) => lib.Variant<'Err', lib.Variant<'AccountDoesNotExist', lib.Variant<'Transaction', T>>>;
      Peer: <const T extends PeerId>(value: T) => lib.Variant<'Err', lib.Variant<'AccountDoesNotExist', lib.Variant<'Peer', T>>>;
      Trigger: <const T extends TriggerId>(value: T) => lib.Variant<'Err', lib.Variant<'AccountDoesNotExist', lib.Variant<'Trigger', T>>>;
      Role: <const T extends RoleId>(value: T) => lib.Variant<'Err', lib.Variant<'AccountDoesNotExist', lib.Variant<'Role', T>>>;
      Permission: <const T extends Permission>(value: T) => lib.Variant<'Err', lib.Variant<'AccountDoesNotExist', lib.Variant<'Permission', T>>>;
      PublicKey: <const T extends lib.PublicKey>(value: T) => lib.Variant<'Err', lib.Variant<'AccountDoesNotExist', lib.Variant<'PublicKey', T>>>;
    };
    LimitCheck: <const T extends TransactionLimitError>(value: T) => lib.Variant<'Err', lib.Variant<'LimitCheck', T>>;
    Validation: {
      NotPermitted: <const T extends lib.String>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'NotPermitted', T>>>;
      InstructionFailed: {
        Evaluate: {
          Unsupported: {
            Register: lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Evaluate', lib.Variant<'Unsupported', lib.VariantUnit<'Register'>>>>>>;
            Unregister: lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Evaluate', lib.Variant<'Unsupported', lib.VariantUnit<'Unregister'>>>>>>;
            Mint: lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Evaluate', lib.Variant<'Unsupported', lib.VariantUnit<'Mint'>>>>>>;
            Burn: lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Evaluate', lib.Variant<'Unsupported', lib.VariantUnit<'Burn'>>>>>>;
            Transfer: lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Evaluate', lib.Variant<'Unsupported', lib.VariantUnit<'Transfer'>>>>>>;
            SetKeyValue: lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Evaluate', lib.Variant<'Unsupported', lib.VariantUnit<'SetKeyValue'>>>>>>;
            RemoveKeyValue: lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Evaluate', lib.Variant<'Unsupported', lib.VariantUnit<'RemoveKeyValue'>>>>>>;
            Grant: lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Evaluate', lib.Variant<'Unsupported', lib.VariantUnit<'Grant'>>>>>>;
            Revoke: lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Evaluate', lib.Variant<'Unsupported', lib.VariantUnit<'Revoke'>>>>>>;
            ExecuteTrigger: lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Evaluate', lib.Variant<'Unsupported', lib.VariantUnit<'ExecuteTrigger'>>>>>>;
            SetParameter: lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Evaluate', lib.Variant<'Unsupported', lib.VariantUnit<'SetParameter'>>>>>>;
            Upgrade: lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Evaluate', lib.Variant<'Unsupported', lib.VariantUnit<'Upgrade'>>>>>>;
            Log: lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Evaluate', lib.Variant<'Unsupported', lib.VariantUnit<'Log'>>>>>>;
            Custom: lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Evaluate', lib.Variant<'Unsupported', lib.VariantUnit<'Custom'>>>>>>;
          };
          PermissionParameter: <const T extends lib.String>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Evaluate', lib.Variant<'PermissionParameter', T>>>>>;
          Type: {
            AssetNumericSpec: <const T extends Mismatch<NumericSpec>>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Evaluate', lib.Variant<'Type', lib.Variant<'AssetNumericSpec', T>>>>>>;
          };
        };
        Query: {
          Find: {
            Asset: <const T extends lib.AssetId>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Query', lib.Variant<'Find', lib.Variant<'Asset', T>>>>>>;
            AssetDefinition: <const T extends lib.AssetDefinitionId>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Query', lib.Variant<'Find', lib.Variant<'AssetDefinition', T>>>>>>;
            Nft: <const T extends lib.NftId>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Query', lib.Variant<'Find', lib.Variant<'Nft', T>>>>>>;
            Account: <const T extends lib.AccountId>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Query', lib.Variant<'Find', lib.Variant<'Account', T>>>>>>;
            Domain: <const T extends lib.DomainId>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Query', lib.Variant<'Find', lib.Variant<'Domain', T>>>>>>;
            MetadataKey: <const T extends lib.Name>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Query', lib.Variant<'Find', lib.Variant<'MetadataKey', T>>>>>>;
            Block: <const T extends lib.Hash>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Query', lib.Variant<'Find', lib.Variant<'Block', T>>>>>>;
            Transaction: <const T extends lib.Hash>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Query', lib.Variant<'Find', lib.Variant<'Transaction', T>>>>>>;
            Peer: <const T extends PeerId>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Query', lib.Variant<'Find', lib.Variant<'Peer', T>>>>>>;
            Trigger: <const T extends TriggerId>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Query', lib.Variant<'Find', lib.Variant<'Trigger', T>>>>>>;
            Role: <const T extends RoleId>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Query', lib.Variant<'Find', lib.Variant<'Role', T>>>>>>;
            Permission: <const T extends Permission>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Query', lib.Variant<'Find', lib.Variant<'Permission', T>>>>>>;
            PublicKey: <const T extends lib.PublicKey>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Query', lib.Variant<'Find', lib.Variant<'PublicKey', T>>>>>>;
          };
          Conversion: <const T extends lib.String>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Query', lib.Variant<'Conversion', T>>>>>;
          NotFound: lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Query', lib.VariantUnit<'NotFound'>>>>>;
          CursorMismatch: lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Query', lib.VariantUnit<'CursorMismatch'>>>>>;
          CursorDone: lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Query', lib.VariantUnit<'CursorDone'>>>>>;
          FetchSizeTooBig: lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Query', lib.VariantUnit<'FetchSizeTooBig'>>>>>;
          InvalidSingularParameters: lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Query', lib.VariantUnit<'InvalidSingularParameters'>>>>>;
          CapacityLimit: lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Query', lib.VariantUnit<'CapacityLimit'>>>>>;
        };
        Conversion: <const T extends lib.String>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Conversion', T>>>>;
        Find: {
          Asset: <const T extends lib.AssetId>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Find', lib.Variant<'Asset', T>>>>>;
          AssetDefinition: <const T extends lib.AssetDefinitionId>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Find', lib.Variant<'AssetDefinition', T>>>>>;
          Nft: <const T extends lib.NftId>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Find', lib.Variant<'Nft', T>>>>>;
          Account: <const T extends lib.AccountId>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Find', lib.Variant<'Account', T>>>>>;
          Domain: <const T extends lib.DomainId>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Find', lib.Variant<'Domain', T>>>>>;
          MetadataKey: <const T extends lib.Name>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Find', lib.Variant<'MetadataKey', T>>>>>;
          Block: <const T extends lib.Hash>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Find', lib.Variant<'Block', T>>>>>;
          Transaction: <const T extends lib.Hash>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Find', lib.Variant<'Transaction', T>>>>>;
          Peer: <const T extends PeerId>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Find', lib.Variant<'Peer', T>>>>>;
          Trigger: <const T extends TriggerId>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Find', lib.Variant<'Trigger', T>>>>>;
          Role: <const T extends RoleId>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Find', lib.Variant<'Role', T>>>>>;
          Permission: <const T extends Permission>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Find', lib.Variant<'Permission', T>>>>>;
          PublicKey: <const T extends lib.PublicKey>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Find', lib.Variant<'PublicKey', T>>>>>;
        };
        Repetition: <const T extends RepetitionError>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Repetition', T>>>>;
        Mintability: {
          MintUnmintable: lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Mintability', lib.VariantUnit<'MintUnmintable'>>>>>;
          ForbidMintOnMintable: lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Mintability', lib.VariantUnit<'ForbidMintOnMintable'>>>>>;
        };
        Math: {
          Overflow: lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Math', lib.VariantUnit<'Overflow'>>>>>;
          NotEnoughQuantity: lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Math', lib.VariantUnit<'NotEnoughQuantity'>>>>>;
          ...
          NegativeValue: lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Math', lib.VariantUnit<'NegativeValue'>>>>>;
          DomainViolation: lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Math', lib.VariantUnit<'DomainViolation'>>>>>;
          Unknown: lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Math', lib.VariantUnit<'Unknown'>>>>>;
          FixedPointConversion: <const T extends lib.String>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Math', lib.Variant<'FixedPointConversion', T>>>>>;
        };
        InvalidParameter: {
          Wasm: <const T extends lib.String>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'InvalidParameter', lib.Variant<'Wasm', T>>>>>;
          TimeTriggerInThePast: lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'InvalidParameter', lib.VariantUnit<'TimeTriggerInThePast'>>>>>;
        };
        InvariantViolation: <const T extends lib.String>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'InvariantViolation', T>>>>;
      };
      QueryFailed: {
        Find: {
          Asset: <const T extends lib.AssetId>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'QueryFailed', lib.Variant<'Find', lib.Variant<'Asset', T>>>>>;
          AssetDefinition: <const T extends lib.AssetDefinitionId>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'QueryFailed', lib.Variant<'Find', lib.Variant<'AssetDefinition', T>>>>>;
          Nft: <const T extends lib.NftId>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'QueryFailed', lib.Variant<'Find', lib.Variant<'Nft', T>>>>>;
          Account: <const T extends lib.AccountId>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'QueryFailed', lib.Variant<'Find', lib.Variant<'Account', T>>>>>;
          Domain: <const T extends lib.DomainId>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'QueryFailed', lib.Variant<'Find', lib.Variant<'Domain', T>>>>>;
          MetadataKey: <const T extends lib.Name>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'QueryFailed', lib.Variant<'Find', lib.Variant<'MetadataKey', T>>>>>;
          Block: <const T extends lib.Hash>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'QueryFailed', lib.Variant<'Find', lib.Variant<'Block', T>>>>>;
          Transaction: <const T extends lib.Hash>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'QueryFailed', lib.Variant<'Find', lib.Variant<'Transaction', T>>>>>;
          Peer: <const T extends PeerId>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'QueryFailed', lib.Variant<'Find', lib.Variant<'Peer', T>>>>>;
          Trigger: <const T extends TriggerId>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'QueryFailed', lib.Variant<'Find', lib.Variant<'Trigger', T>>>>>;
          Role: <const T extends RoleId>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'QueryFailed', lib.Variant<'Find', lib.Variant<'Role', T>>>>>;
          Permission: <const T extends Permission>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'QueryFailed', lib.Variant<'Find', lib.Variant<'Permission', T>>>>>;
          PublicKey: <const T extends lib.PublicKey>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'QueryFailed', lib.Variant<'Find', lib.Variant<'PublicKey', T>>>>>;
        };
        Conversion: <const T extends lib.String>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'QueryFailed', lib.Variant<'Conversion', T>>>>;
        NotFound: lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'QueryFailed', lib.VariantUnit<'NotFound'>>>>;
        CursorMismatch: lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'QueryFailed', lib.VariantUnit<'CursorMismatch'>>>>;
        CursorDone: lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'QueryFailed', lib.VariantUnit<'CursorDone'>>>>;
        FetchSizeTooBig: lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'QueryFailed', lib.VariantUnit<'FetchSizeTooBig'>>>>;
        InvalidSingularParameters: lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'QueryFailed', lib.VariantUnit<'InvalidSingularParameters'>>>>;
        CapacityLimit: lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'QueryFailed', lib.VariantUnit<'CapacityLimit'>>>>;
      };
      TooComplex: lib.Variant<'Err', lib.Variant<'Validation', lib.VariantUnit<'TooComplex'>>>;
      InternalError: lib.Variant<'Err', lib.Variant<'Validation', lib.VariantUnit<'InternalError'>>>;
    };
    InstructionExecution: <const T extends InstructionExecutionFail>(value: T) => lib.Variant<'Err', lib.Variant<'InstructionExecution', T>>;
    WasmExecution: <const T extends WasmExecutionFail>(value: T) => lib.Variant<'Err', lib.Variant<'WasmExecution', T>>;
    TriggerExecution: {
      MaxDepthExceeded: lib.Variant<'Err', lib.Variant<'TriggerExecution', lib.VariantUnit<'MaxDepthExceeded'>>>;
    };
  };
};
/**
 ...
 */ export interface BlockResult {
  timeTriggers: lib.Vec<TimeTriggerEntrypoint>;
  merkle: MerkleTree;
  resultMerkle: MerkleTree;
  transactionResults: lib.Vec<TransactionResult>;
}
/**
 * Codec of the structure.
 */ export declare const BlockResult: lib.CodecContainer<BlockResult>;
/**
 * Structure with named fields.
 ...
 */ export interface SignedBlockV1 {
  signatures: lib.BTreeSet<lib.BlockSignature>;
 ...
 */ export declare const BlockStreamMessage: lib.CodecContainer<BlockStreamMessage> & {
  Subscribe: <const T extends BlockSubscriptionRequest>(value: T) => lib.Variant<'Subscribe', T>;
  Next: lib.VariantUnit<'Next'>;
  Block: {
    V1: <const T extends SignedBlockV1>(value: T) => lib.Variant<'Block', lib.Variant<'V1', T>>;
  };
};
/**
 * Structure with named fields and generic parameters.
 ...
 */ export interface MerkleProof {
  leafIndex: lib.U32;
  auditPath: lib.Vec<lib.Option<lib.Hash>>;
}
/**
 * Codec of the structure.
 */ export declare const MerkleProof: lib.CodecContainer<MerkleProof>;
/**
 * Enumeration (discriminated union). Represented as one of the following variants:
 * 
 * - `External`
 ...
 */ export declare const TransactionEntrypoint: lib.CodecContainer<TransactionEntrypoint> & {
  External: {
    V1: <const T extends SignedTransactionV1>(value: T) => lib.Variant<'External', lib.Variant<'V1', T>>;
  };
  Time: <const T extends TimeTriggerEntrypoint>(value: T) => lib.Variant<'Time', T>;
};
/**
 * Structure with named fields.
 */ export interface CommittedTransaction {
  blockHash: lib.Hash;
  entrypointHash: lib.Hash;
  entrypointProof: MerkleProof;
  entrypoint: TransactionEntrypoint;
  resultHash: lib.Hash;
  resultProof: MerkleProof;
 ...
 */ export declare const TransactionEntrypointHashPredicateAtom: lib.CodecContainer<TransactionEntrypointHashPredicateAtom> & {
  Equals: <const T extends lib.Hash>(value: T) => lib.Variant<'Equals', T>;
};
/**
 * Enumeration (discriminated union). Represented as one of the following variants:
 ...
 */ export declare const TransactionEntrypointHashProjectionPredicate: lib.CodecContainer<TransactionEntrypointHashProjectionPredicate> & {
  Atom: {
    Equals: <const T extends lib.Hash>(value: T) => lib.Variant<'Atom', lib.Variant<'Equals', T>>;
  };
};
 ...
 */ export declare const TransactionEntrypointPredicateAtom: lib.CodecContainer<TransactionEntrypointPredicateAtom> & {
  IsExternal: lib.VariantUnit<'IsExternal'>;
};
/**
 * Enumeration (discriminated union). Represented as one of the following variants:
 * 
 ...
 */ export declare const TransactionEntrypointProjectionPredicate: lib.CodecContainer<TransactionEntrypointProjectionPredicate> & {
  Atom: {
    IsExternal: lib.Variant<'Atom', lib.VariantUnit<'IsExternal'>>;
  };
  Authority: {
    Atom: {
 ...
 */ export declare const TransactionResultHashPredicateAtom: lib.CodecContainer<TransactionResultHashPredicateAtom> & {
  Equals: <const T extends lib.Hash>(value: T) => lib.Variant<'Equals', T>;
};
/**
 * Enumeration (discriminated union). Represented as one of the following variants:
 ...
 */ export declare const TransactionResultHashProjectionPredicate: lib.CodecContainer<TransactionResultHashProjectionPredicate> & {
  Atom: {
    Equals: <const T extends lib.Hash>(value: T) => lib.Variant<'Atom', lib.Variant<'Equals', T>>;
  };
};
 ...
 */ export declare const TransactionResultPredicateAtom: lib.CodecContainer<TransactionResultPredicateAtom> & {
  IsOk: lib.VariantUnit<'IsOk'>;
  ContainsDataTrigger: <const T extends TriggerId>(value: T) => lib.Variant<'ContainsDataTrigger', T>;
};
/**
 * Enumeration (discriminated union). Represented as one of the following variants:
 * 
 ...
 */ export declare const TransactionResultProjectionPredicate: lib.CodecContainer<TransactionResultProjectionPredicate> & {
  Atom: {
    IsOk: lib.Variant<'Atom', lib.VariantUnit<'IsOk'>>;
    ContainsDataTrigger: <const T extends TriggerId>(value: T) => lib.Variant<'Atom', lib.Variant<'ContainsDataTrigger', T>>;
  };
};
/**
 * Enumeration (discriminated union). Represented as one of the following variants:
 ...
 */ export declare const CommittedTransactionProjectionPredicate: lib.CodecContainer<CommittedTransactionProjectionPredicate> & {
  ...
  TransactionEntrypointHash: {
    Atom: {
      Equals: <const T extends lib.Hash>(value: T) => lib.Variant<'TransactionEntrypointHash', lib.Variant<'Atom', lib.Variant<'Equals', T>>>;
    };
  };
  TransactionEntrypoint: {
    Atom: {
      IsExternal: lib.Variant<'TransactionEntrypoint', lib.Variant<'Atom', lib.VariantUnit<'IsExternal'>>>;
    };
    Authority: {
      Atom: {
        Equals: <const T extends lib.AccountId>(value: T) => lib.Variant<'TransactionEntrypoint', lib.Variant<'Authority', lib.Variant<'Atom', lib.Variant<'Equals', T>>>>;
      };
      Domain: {
        Atom: {
          Equals: <const T extends lib.DomainId>(value: T) => lib.Variant<'TransactionEntrypoint', lib.Variant<'Authority', lib.Variant<'Domain', lib.Variant<'Atom', lib.Variant<'Equals', T>>>>>;
        };
        Name: {
          Atom: {
            Equals: <const T extends lib.String>(value: T) => lib.Variant<'TransactionEntrypoint', lib.Variant<'Authority', lib.Variant<'Domain', lib.Variant<'Name', lib.Variant<'Atom', lib.Variant<'Equals', T>>>>>>;
            Contains: <const T extends lib.String>(value: T) => lib.Variant<'TransactionEntrypoint', lib.Variant<'Authority', lib.Variant<'Domain', lib.Variant<'Name', lib.Variant<'Atom', lib.Variant<'Contains', T>>>>>>;
            StartsWith: <const T extends lib.String>(value: T) => lib.Variant<'TransactionEntrypoint', lib.Variant<'Authority', lib.Variant<'Domain', lib.Variant<'Name', lib.Variant<'Atom', lib.Variant<'StartsWith', T>>>>>>;
            EndsWith: <const T extends lib.String>(value: T) => lib.Variant<'TransactionEntrypoint', lib.Variant<'Authority', lib.Variant<'Domain', lib.Variant<'Name', lib.Variant<'Atom', lib.Variant<'EndsWith', T>>>>>>;
          };
        };
      };
      Signatory: {
        Atom: {
          Equals: <const T extends lib.PublicKey>(value: T) => lib.Variant<'TransactionEntrypoint', lib.Variant<'Authority', lib.Variant<'Signatory', lib.Variant<'Atom', lib.Variant<'Equals', T>>>>>;
        };
      };
    };
  };
  TransactionResultHash: {
    Atom: {
      Equals: <const T extends lib.Hash>(value: T) => lib.Variant<'TransactionResultHash', lib.Variant<'Atom', lib.Variant<'Equals', T>>>;
    };
  };
  TransactionResult: {
    Atom: {
      IsOk: lib.Variant<'TransactionResult', lib.Variant<'Atom', lib.VariantUnit<'IsOk'>>>;
      ContainsDataTrigger: <const T extends TriggerId>(value: T) => lib.Variant<'TransactionResult', lib.Variant<'Atom', lib.Variant<'ContainsDataTrigger', T>>>;
    };
  };
};
/**
 ...
 */ export declare const TransactionEntrypointHashProjectionSelector: lib.CodecContainer<TransactionEntrypointHashProjectionSelector> & {
  Atom: lib.VariantUnit<'Atom'>;
};
/**
 * Enumeration (discriminated union). Represented as one of the following variants:
 ...
 */ export declare const TransactionEntrypointProjectionSelector: lib.CodecContainer<TransactionEntrypointProjectionSelector> & {
  Atom: lib.VariantUnit<'Atom'>;
  Authority: {
 ...
 */ export declare const TransactionResultHashProjectionSelector: lib.CodecContainer<TransactionResultHashProjectionSelector> & {
  Atom: lib.VariantUnit<'Atom'>;
};
/**
 * Enumeration (discriminated union). Represented as one of the following variants:
 ...
 */ export declare const TransactionResultProjectionSelector: lib.CodecContainer<TransactionResultProjectionSelector> & {
  Atom: lib.VariantUnit<'Atom'>;
};
/**
 * Enumeration (discriminated union). Represented as one of the following variants:
 ...
 */ export declare const CommittedTransactionProjectionSelector: lib.CodecContainer<CommittedTransactionProjectionSelector> & {
  ...
  TransactionEntrypointHash: {
    Atom: lib.Variant<'TransactionEntrypointHash', lib.VariantUnit<'Atom'>>;
  };
  TransactionEntrypoint: {
    Atom: lib.Variant<'TransactionEntrypoint', lib.VariantUnit<'Atom'>>;
    Authority: {
      Atom: lib.Variant<'TransactionEntrypoint', lib.Variant<'Authority', lib.VariantUnit<'Atom'>>>;
      Domain: {
        Atom: lib.Variant<'TransactionEntrypoint', lib.Variant<'Authority', lib.Variant<'Domain', lib.VariantUnit<'Atom'>>>>;
        Name: {
          Atom: lib.Variant<'TransactionEntrypoint', lib.Variant<'Authority', lib.Variant<'Domain', lib.Variant<'Name', lib.VariantUnit<'Atom'>>>>>;
        };
      };
      Signatory: {
        Atom: lib.Variant<'TransactionEntrypoint', lib.Variant<'Authority', lib.Variant<'Signatory', lib.VariantUnit<'Atom'>>>>;
      };
    };
  };
  TransactionResultHash: {
    Atom: lib.Variant<'TransactionResultHash', lib.VariantUnit<'Atom'>>;
  };
  TransactionResult: {
    Atom: lib.Variant<'TransactionResult', lib.VariantUnit<'Atom'>>;
  };
};
/**
 * This type could not be constructed.
 ...
 */ export declare const SmartContractParameter: lib.CodecContainer<SmartContractParameter> & {
  ...
  ExecutionDepth: <const T extends lib.U8>(value: T) => lib.Variant<'ExecutionDepth', T>;
};
/**
 * Structure with named fields.
 ...
 */ export declare const Parameter: lib.CodecContainer<Parameter> & {
  ...
  SmartContract: {
    ...
    ExecutionDepth: <const T extends lib.U8>(value: T) => lib.Variant<'SmartContract', lib.Variant<'ExecutionDepth', T>>;
  };
  Executor: {
    ...
    ExecutionDepth: <const T extends lib.U8>(value: T) => lib.Variant<'Executor', lib.Variant<'ExecutionDepth', T>>;
  };
 ...
 */ export declare const Order: lib.CodecContainer<Order> & {
  Ascending: lib.VariantUnit<'Ascending'>;
  Descending: lib.VariantUnit<'Descending'>;
};
/**
 * Structure with named fields.
 */ export interface FindBlockHeaders {
  order: Order;
}
/**
 * Codec of the structure.
 */ export declare const FindBlockHeaders: lib.CodecContainer<FindBlockHeaders>;
/**
 * Structure with named fields.
 */ export interface FindBlocks {
  order: Order;
}
/**
 * Codec of the structure.
 */ export declare const FindBlocks: lib.CodecContainer<FindBlocks>;
/**
 * Structure with named fields.
 ...
 */ export declare const InstructionBox: lib.CodecContainer<InstructionBox> & {
  ...
  SetParameter: {
    ...
    SmartContract: {
      ...
      ExecutionDepth: <const T extends lib.U8>(value: T) => lib.Variant<'SetParameter', lib.Variant<'SmartContract', lib.Variant<'ExecutionDepth', T>>>;
    };
    Executor: {
      ...
      ExecutionDepth: <const T extends lib.U8>(value: T) => lib.Variant<'SetParameter', lib.Variant<'Executor', lib.Variant<'ExecutionDepth', T>>>;
    };
 ...
 */ export declare const QueryBox: lib.CodecContainer<QueryBox> & {
  ...
  FindBlocks: <const T extends QueryWithFilter<FindBlocks, lib.CompoundPredicate<SignedBlockProjectionPredicate>, lib.Vec<SignedBlockProjectionSelector>>>(value: T) => lib.Variant<'FindBlocks', T>;
  FindBlockHeaders: <const T extends QueryWithFilter<FindBlockHeaders, lib.CompoundPredicate<BlockHeaderProjectionPredicate>, lib.Vec<BlockHeaderProjectionSelector>>>(value: T) => lib.Variant<'FindBlockHeaders', T>;
};
/**
 * Enumeration (discriminated union). Represented as one of the following variants:
 * 
 ...
 */ export declare const QueryOutputBatchBox: lib.CodecContainer<QueryOutputBatchBox> & {
  ...
  TransactionResult: <const T extends lib.Vec<TransactionResult>>(value: T) => lib.Variant<'TransactionResult', T>;
  TransactionResultHash: <const T extends lib.Vec<lib.Hash>>(value: T) => lib.Variant<'TransactionResultHash', T>;
  TransactionEntrypoint: <const T extends lib.Vec<TransactionEntrypoint>>(value: T) => lib.Variant<'TransactionEntrypoint', T>;
  TransactionEntrypointHash: <const T extends lib.Vec<lib.Hash>>(value: T) => lib.Variant<'TransactionEntrypointHash', T>;
 ...
 */ export interface Status {
  ...
  commitTime: lib.DurationCompact;
