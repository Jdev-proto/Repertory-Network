 ...
 * TODO how to construct, how to use
 */
export type TriggerExecutionFail = lib.VariantUnit<'MaxDepthExceeded'>
/**
 * Codec and constructors for enumeration {@link TriggerExecutionFail}.
 */
export const TriggerExecutionFail: lib.CodecContainer<TriggerExecutionFail> & { MaxDepthExceeded: lib.VariantUnit<'MaxDepthExceeded'> } = { ...{ MaxDepthExceeded: Object.freeze({ kind: 'MaxDepthExceeded' }) }, ...lib.defineCodec(lib.enumCodec<{ MaxDepthExceeded: [] }>({ MaxDepthExceeded: [0] }).discriminated()) }
 ...
 * Structure with named fields.
 */
export interface BlockHeader { height: lib.NonZero<lib.U64>, prevBlockHash: lib.Option<lib.Hash>, merkleRoot: lib.Option<lib.Hash>, resultMerkleRoot: lib.Option<lib.Hash>, creationTime: lib.Timestamp, viewChangeIndex: lib.U32 }
/**
 * Codec of the structure.
 */
export const BlockHeader: lib.CodecContainer<BlockHeader> = lib.defineCodec(lib.structCodec<BlockHeader>(['height', 'prevBlockHash', 'merkleRoot', 'resultMerkleRoot', 'creationTime', 'viewChangeIndex'], {height: lib.NonZero.with(lib.getCodec(lib.U64)), prevBlockHash: lib.Option.with(lib.getCodec(lib.Hash)), merkleRoot: lib.Option.with(lib.getCodec(lib.Hash)), resultMerkleRoot: lib.Option.with(lib.getCodec(lib.Hash)), creationTime: lib.getCodec(lib.Timestamp), viewChangeIndex: lib.getCodec(lib.U32)}))
...
export type ExecutionStep = lib.Vec<InstructionBox>
export const ExecutionStep: lib.CodecContainer<ExecutionStep> = lib.defineCodec(lib.Vec.with(lib.lazyCodec(() => lib.getCodec(InstructionBox))))

/**
 * Structure with named fields.
 */
export interface TimeTriggerEntrypoint { id: TriggerId, instructions: ExecutionStep, authority: lib.AccountId }
/**
 * Codec of the structure.
 */
export const TimeTriggerEntrypoint: lib.CodecContainer<TimeTriggerEntrypoint> = lib.defineCodec(lib.structCodec<TimeTriggerEntrypoint>(['id', 'instructions', 'authority'], {id: lib.getCodec(TriggerId), instructions: lib.getCodec(ExecutionStep), authority: lib.getCodec(lib.AccountId)}))

export type MerkleTree = lib.Vec<lib.Option<lib.Hash>>
export const MerkleTree: lib.CodecContainer<MerkleTree> = lib.defineCodec(lib.Vec.with(lib.Option.with(lib.getCodec(lib.Hash))))

/**
 * Structure with named fields.
 */
export interface DataTriggerStep { id: TriggerId, instructions: ExecutionStep }
/**
 * Codec of the structure.
 */
export const DataTriggerStep: lib.CodecContainer<DataTriggerStep> = lib.defineCodec(lib.structCodec<DataTriggerStep>(['id', 'instructions'], {id: lib.getCodec(TriggerId), instructions: lib.getCodec(ExecutionStep)}))
 ...
 * TODO how to construct, how to use
 */
export type TransactionResult = lib.Variant<'Ok', lib.Vec<DataTriggerStep>> | lib.Variant<'Err', TransactionRejectionReason>
/**
 * Codec and constructors for enumeration {@link TransactionResult}.
 */
export const TransactionResult: lib.CodecContainer<TransactionResult> & { Ok: <const T extends lib.Vec<DataTriggerStep>>(value: T) => lib.Variant<'Ok', T>, Err: { AccountDoesNotExist: { Asset: <const T extends lib.AssetId>(value: T) => lib.Variant<'Err', lib.Variant<'AccountDoesNotExist', lib.Variant<'Asset', T>>>, AssetDefinition: <const T extends lib.AssetDefinitionId>(value: T) => lib.Variant<'Err', lib.Variant<'AccountDoesNotExist', lib.Variant<'AssetDefinition', T>>>, Nft: <const T extends lib.NftId>(value: T) => lib.Variant<'Err', lib.Variant<'AccountDoesNotExist', lib.Variant<'Nft', T>>>, Account: <const T extends lib.AccountId>(value: T) => lib.Variant<'Err', lib.Variant<'AccountDoesNotExist', lib.Variant<'Account', T>>>, Domain: <const T extends lib.DomainId>(value: T) => lib.Variant<'Err', lib.Variant<'AccountDoesNotExist', lib.Variant<'Domain', T>>>, MetadataKey: <const T extends lib.Name>(value: T) => lib.Variant<'Err', lib.Variant<'AccountDoesNotExist', lib.Variant<'MetadataKey', T>>>, Block: <const T extends lib.Hash>(value: T) => lib.Variant<'Err', lib.Variant<'AccountDoesNotExist', lib.Variant<'Block', T>>>, Transaction: <const T extends lib.Hash>(value: T) => lib.Variant<'Err', lib.Variant<'AccountDoesNotExist', lib.Variant<'Transaction', T>>>, Peer: <const T extends PeerId>(value: T) => lib.Variant<'Err', lib.Variant<'AccountDoesNotExist', lib.Variant<'Peer', T>>>, Trigger: <const T extends TriggerId>(value: T) => lib.Variant<'Err', lib.Variant<'AccountDoesNotExist', lib.Variant<'Trigger', T>>>, Role: <const T extends RoleId>(value: T) => lib.Variant<'Err', lib.Variant<'AccountDoesNotExist', lib.Variant<'Role', T>>>, Permission: <const T extends Permission>(value: T) => lib.Variant<'Err', lib.Variant<'AccountDoesNotExist', lib.Variant<'Permission', T>>>, PublicKey: <const T extends lib.PublicKey>(value: T) => lib.Variant<'Err', lib.Variant<'AccountDoesNotExist', lib.Variant<'PublicKey', T>>> }, LimitCheck: <const T extends TransactionLimitError>(value: T) => lib.Variant<'Err', lib.Variant<'LimitCheck', T>>, Validation: { NotPermitted: <const T extends lib.String>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'NotPermitted', T>>>, InstructionFailed: { Evaluate: { Unsupported: { Register: lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Evaluate', lib.Variant<'Unsupported', lib.VariantUnit<'Register'>>>>>>, Unregister: lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Evaluate', lib.Variant<'Unsupported', lib.VariantUnit<'Unregister'>>>>>>, Mint: lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Evaluate', lib.Variant<'Unsupported', lib.VariantUnit<'Mint'>>>>>>, Burn: lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Evaluate', lib.Variant<'Unsupported', lib.VariantUnit<'Burn'>>>>>>, Transfer: lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Evaluate', lib.Variant<'Unsupported', lib.VariantUnit<'Transfer'>>>>>>, SetKeyValue: lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Evaluate', lib.Variant<'Unsupported', lib.VariantUnit<'SetKeyValue'>>>>>>, RemoveKeyValue: lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Evaluate', lib.Variant<'Unsupported', lib.VariantUnit<'RemoveKeyValue'>>>>>>, Grant: lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Evaluate', lib.Variant<'Unsupported', lib.VariantUnit<'Grant'>>>>>>, Revoke: lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Evaluate', lib.Variant<'Unsupported', lib.VariantUnit<'Revoke'>>>>>>, ExecuteTrigger: lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Evaluate', lib.Variant<'Unsupported', lib.VariantUnit<'ExecuteTrigger'>>>>>>, SetParameter: lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Evaluate', lib.Variant<'Unsupported', lib.VariantUnit<'SetParameter'>>>>>>, Upgrade: lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Evaluate', lib.Variant<'Unsupported', lib.VariantUnit<'Upgrade'>>>>>>, Log: lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Evaluate', lib.Variant<'Unsupported', lib.VariantUnit<'Log'>>>>>>, Custom: lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Evaluate', lib.Variant<'Unsupported', lib.VariantUnit<'Custom'>>>>>> }, PermissionParameter: <const T extends lib.String>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Evaluate', lib.Variant<'PermissionParameter', T>>>>>, Type: { AssetNumericSpec: <const T extends Mismatch<NumericSpec>>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Evaluate', lib.Variant<'Type', lib.Variant<'AssetNumericSpec', T>>>>>> } }, Query: { Find: { Asset: <const T extends lib.AssetId>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Query', lib.Variant<'Find', lib.Variant<'Asset', T>>>>>>, AssetDefinition: <const T extends lib.AssetDefinitionId>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Query', lib.Variant<'Find', lib.Variant<'AssetDefinition', T>>>>>>, Nft: <const T extends lib.NftId>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Query', lib.Variant<'Find', lib.Variant<'Nft', T>>>>>>, Account: <const T extends lib.AccountId>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Query', lib.Variant<'Find', lib.Variant<'Account', T>>>>>>, Domain: <const T extends lib.DomainId>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Query', lib.Variant<'Find', lib.Variant<'Domain', T>>>>>>, MetadataKey: <const T extends lib.Name>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Query', lib.Variant<'Find', lib.Variant<'MetadataKey', T>>>>>>, Block: <const T extends lib.Hash>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Query', lib.Variant<'Find', lib.Variant<'Block', T>>>>>>, Transaction: <const T extends lib.Hash>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Query', lib.Variant<'Find', lib.Variant<'Transaction', T>>>>>>, Peer: <const T extends PeerId>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Query', lib.Variant<'Find', lib.Variant<'Peer', T>>>>>>, Trigger: <const T extends TriggerId>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Query', lib.Variant<'Find', lib.Variant<'Trigger', T>>>>>>, Role: <const T extends RoleId>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Query', lib.Variant<'Find', lib.Variant<'Role', T>>>>>>, Permission: <const T extends Permission>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Query', lib.Variant<'Find', lib.Variant<'Permission', T>>>>>>, PublicKey: <const T extends lib.PublicKey>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Query', lib.Variant<'Find', lib.Variant<'PublicKey', T>>>>>> }, Conversion: <const T extends lib.String>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Query', lib.Variant<'Conversion', T>>>>>, NotFound: lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Query', lib.VariantUnit<'NotFound'>>>>>, CursorMismatch: lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Query', lib.VariantUnit<'CursorMismatch'>>>>>, CursorDone: lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Query', lib.VariantUnit<'CursorDone'>>>>>, FetchSizeTooBig: lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Query', lib.VariantUnit<'FetchSizeTooBig'>>>>>, InvalidSingularParameters: lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Query', lib.VariantUnit<'InvalidSingularParameters'>>>>>, CapacityLimit: lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Query', lib.VariantUnit<'CapacityLimit'>>>>> }, Conversion: <const T extends lib.String>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Conversion', T>>>>, Find: { Asset: <const T extends lib.AssetId>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Find', lib.Variant<'Asset', T>>>>>, AssetDefinition: <const T extends lib.AssetDefinitionId>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Find', lib.Variant<'AssetDefinition', T>>>>>, Nft: <const T extends lib.NftId>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Find', lib.Variant<'Nft', T>>>>>, Account: <const T extends lib.AccountId>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Find', lib.Variant<'Account', T>>>>>, Domain: <const T extends lib.DomainId>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Find', lib.Variant<'Domain', T>>>>>, MetadataKey: <const T extends lib.Name>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Find', lib.Variant<'MetadataKey', T>>>>>, Block: <const T extends lib.Hash>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Find', lib.Variant<'Block', T>>>>>, Transaction: <const T extends lib.Hash>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Find', lib.Variant<'Transaction', T>>>>>, Peer: <const T extends PeerId>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Find', lib.Variant<'Peer', T>>>>>, Trigger: <const T extends TriggerId>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Find', lib.Variant<'Trigger', T>>>>>, Role: <const T extends RoleId>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Find', lib.Variant<'Role', T>>>>>, Permission: <const T extends Permission>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Find', lib.Variant<'Permission', T>>>>>, PublicKey: <const T extends lib.PublicKey>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Find', lib.Variant<'PublicKey', T>>>>> }, Repetition: <const T extends RepetitionError>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Repetition', T>>>>, Mintability: { MintUnmintable: lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Mintability', lib.VariantUnit<'MintUnmintable'>>>>>, ForbidMintOnMintable: lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Mintability', lib.VariantUnit<'ForbidMintOnMintable'>>>>> }, Math: { Overflow: lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Math', lib.VariantUnit<'Overflow'>>>>>, NotEnoughQuantity: lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Math', lib.VariantUnit<'NotEnoughQuantity'>>>>>, DivideByZero: lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Math', lib.VariantUnit<'DivideByZero'>>>>>, NegativeValue: lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Math', lib.VariantUnit<'NegativeValue'>>>>>, DomainViolation: lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Math', lib.VariantUnit<'DomainViolation'>>>>>, Unknown: lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Math', lib.VariantUnit<'Unknown'>>>>>, FixedPointConversion: <const T extends lib.String>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Math', lib.Variant<'FixedPointConversion', T>>>>> }, InvalidParameter: { Wasm: <const T extends lib.String>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'InvalidParameter', lib.Variant<'Wasm', T>>>>>, TimeTriggerInThePast: lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'InvalidParameter', lib.VariantUnit<'TimeTriggerInThePast'>>>>> }, InvariantViolation: <const T extends lib.String>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'InvariantViolation', T>>>> }, QueryFailed: { Find: { Asset: <const T extends lib.AssetId>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'QueryFailed', lib.Variant<'Find', lib.Variant<'Asset', T>>>>>, AssetDefinition: <const T extends lib.AssetDefinitionId>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'QueryFailed', lib.Variant<'Find', lib.Variant<'AssetDefinition', T>>>>>, Nft: <const T extends lib.NftId>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'QueryFailed', lib.Variant<'Find', lib.Variant<'Nft', T>>>>>, Account: <const T extends lib.AccountId>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'QueryFailed', lib.Variant<'Find', lib.Variant<'Account', T>>>>>, Domain: <const T extends lib.DomainId>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'QueryFailed', lib.Variant<'Find', lib.Variant<'Domain', T>>>>>, MetadataKey: <const T extends lib.Name>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'QueryFailed', lib.Variant<'Find', lib.Variant<'MetadataKey', T>>>>>, Block: <const T extends lib.Hash>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'QueryFailed', lib.Variant<'Find', lib.Variant<'Block', T>>>>>, Transaction: <const T extends lib.Hash>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'QueryFailed', lib.Variant<'Find', lib.Variant<'Transaction', T>>>>>, Peer: <const T extends PeerId>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'QueryFailed', lib.Variant<'Find', lib.Variant<'Peer', T>>>>>, Trigger: <const T extends TriggerId>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'QueryFailed', lib.Variant<'Find', lib.Variant<'Trigger', T>>>>>, Role: <const T extends RoleId>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'QueryFailed', lib.Variant<'Find', lib.Variant<'Role', T>>>>>, Permission: <const T extends Permission>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'QueryFailed', lib.Variant<'Find', lib.Variant<'Permission', T>>>>>, PublicKey: <const T extends lib.PublicKey>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'QueryFailed', lib.Variant<'Find', lib.Variant<'PublicKey', T>>>>> }, Conversion: <const T extends lib.String>(value: T) => lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'QueryFailed', lib.Variant<'Conversion', T>>>>, NotFound: lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'QueryFailed', lib.VariantUnit<'NotFound'>>>>, CursorMismatch: lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'QueryFailed', lib.VariantUnit<'CursorMismatch'>>>>, CursorDone: lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'QueryFailed', lib.VariantUnit<'CursorDone'>>>>, FetchSizeTooBig: lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'QueryFailed', lib.VariantUnit<'FetchSizeTooBig'>>>>, InvalidSingularParameters: lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'QueryFailed', lib.VariantUnit<'InvalidSingularParameters'>>>>, CapacityLimit: lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'QueryFailed', lib.VariantUnit<'CapacityLimit'>>>> }, TooComplex: lib.Variant<'Err', lib.Variant<'Validation', lib.VariantUnit<'TooComplex'>>>, InternalError: lib.Variant<'Err', lib.Variant<'Validation', lib.VariantUnit<'InternalError'>>> }, InstructionExecution: <const T extends InstructionExecutionFail>(value: T) => lib.Variant<'Err', lib.Variant<'InstructionExecution', T>>, WasmExecution: <const T extends WasmExecutionFail>(value: T) => lib.Variant<'Err', lib.Variant<'WasmExecution', T>>, TriggerExecution: { MaxDepthExceeded: lib.Variant<'Err', lib.Variant<'TriggerExecution', lib.VariantUnit<'MaxDepthExceeded'>>> } } } = { ...{ Ok: <const T extends lib.Vec<DataTriggerStep>>(value: T): lib.Variant<'Ok', T> => ({ kind: 'Ok', value }), Err: { AccountDoesNotExist: { Asset: <const T extends lib.AssetId>(value: T): lib.Variant<'Err', lib.Variant<'AccountDoesNotExist', lib.Variant<'Asset', T>>> => ({ kind: 'Err', value: TransactionRejectionReason.AccountDoesNotExist.Asset(value) }), AssetDefinition: <const T extends lib.AssetDefinitionId>(value: T): lib.Variant<'Err', lib.Variant<'AccountDoesNotExist', lib.Variant<'AssetDefinition', T>>> => ({ kind: 'Err', value: TransactionRejectionReason.AccountDoesNotExist.AssetDefinition(value) }), Nft: <const T extends lib.NftId>(value: T): lib.Variant<'Err', lib.Variant<'AccountDoesNotExist', lib.Variant<'Nft', T>>> => ({ kind: 'Err', value: TransactionRejectionReason.AccountDoesNotExist.Nft(value) }), Account: <const T extends lib.AccountId>(value: T): lib.Variant<'Err', lib.Variant<'AccountDoesNotExist', lib.Variant<'Account', T>>> => ({ kind: 'Err', value: TransactionRejectionReason.AccountDoesNotExist.Account(value) }), Domain: <const T extends lib.DomainId>(value: T): lib.Variant<'Err', lib.Variant<'AccountDoesNotExist', lib.Variant<'Domain', T>>> => ({ kind: 'Err', value: TransactionRejectionReason.AccountDoesNotExist.Domain(value) }), MetadataKey: <const T extends lib.Name>(value: T): lib.Variant<'Err', lib.Variant<'AccountDoesNotExist', lib.Variant<'MetadataKey', T>>> => ({ kind: 'Err', value: TransactionRejectionReason.AccountDoesNotExist.MetadataKey(value) }), Block: <const T extends lib.Hash>(value: T): lib.Variant<'Err', lib.Variant<'AccountDoesNotExist', lib.Variant<'Block', T>>> => ({ kind: 'Err', value: TransactionRejectionReason.AccountDoesNotExist.Block(value) }), Transaction: <const T extends lib.Hash>(value: T): lib.Variant<'Err', lib.Variant<'AccountDoesNotExist', lib.Variant<'Transaction', T>>> => ({ kind: 'Err', value: TransactionRejectionReason.AccountDoesNotExist.Transaction(value) }), Peer: <const T extends PeerId>(value: T): lib.Variant<'Err', lib.Variant<'AccountDoesNotExist', lib.Variant<'Peer', T>>> => ({ kind: 'Err', value: TransactionRejectionReason.AccountDoesNotExist.Peer(value) }), Trigger: <const T extends TriggerId>(value: T): lib.Variant<'Err', lib.Variant<'AccountDoesNotExist', lib.Variant<'Trigger', T>>> => ({ kind: 'Err', value: TransactionRejectionReason.AccountDoesNotExist.Trigger(value) }), Role: <const T extends RoleId>(value: T): lib.Variant<'Err', lib.Variant<'AccountDoesNotExist', lib.Variant<'Role', T>>> => ({ kind: 'Err', value: TransactionRejectionReason.AccountDoesNotExist.Role(value) }), Permission: <const T extends Permission>(value: T): lib.Variant<'Err', lib.Variant<'AccountDoesNotExist', lib.Variant<'Permission', T>>> => ({ kind: 'Err', value: TransactionRejectionReason.AccountDoesNotExist.Permission(value) }), PublicKey: <const T extends lib.PublicKey>(value: T): lib.Variant<'Err', lib.Variant<'AccountDoesNotExist', lib.Variant<'PublicKey', T>>> => ({ kind: 'Err', value: TransactionRejectionReason.AccountDoesNotExist.PublicKey(value) }) }, LimitCheck: <const T extends TransactionLimitError>(value: T): lib.Variant<'Err', lib.Variant<'LimitCheck', T>> => ({ kind: 'Err', value: TransactionRejectionReason.LimitCheck(value) }), Validation: { NotPermitted: <const T extends lib.String>(value: T): lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'NotPermitted', T>>> => ({ kind: 'Err', value: TransactionRejectionReason.Validation.NotPermitted(value) }), InstructionFailed: { Evaluate: { Unsupported: { Register: Object.freeze<lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Evaluate', lib.Variant<'Unsupported', lib.VariantUnit<'Register'>>>>>>>({ kind: 'Err', value: TransactionRejectionReason.Validation.InstructionFailed.Evaluate.Unsupported.Register }), Unregister: Object.freeze<lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Evaluate', lib.Variant<'Unsupported', lib.VariantUnit<'Unregister'>>>>>>>({ kind: 'Err', value: TransactionRejectionReason.Validation.InstructionFailed.Evaluate.Unsupported.Unregister }), Mint: Object.freeze<lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Evaluate', lib.Variant<'Unsupported', lib.VariantUnit<'Mint'>>>>>>>({ kind: 'Err', value: TransactionRejectionReason.Validation.InstructionFailed.Evaluate.Unsupported.Mint }), Burn: Object.freeze<lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Evaluate', lib.Variant<'Unsupported', lib.VariantUnit<'Burn'>>>>>>>({ kind: 'Err', value: TransactionRejectionReason.Validation.InstructionFailed.Evaluate.Unsupported.Burn }), Transfer: Object.freeze<lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Evaluate', lib.Variant<'Unsupported', lib.VariantUnit<'Transfer'>>>>>>>({ kind: 'Err', value: TransactionRejectionReason.Validation.InstructionFailed.Evaluate.Unsupported.Transfer }), SetKeyValue: Object.freeze<lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Evaluate', lib.Variant<'Unsupported', lib.VariantUnit<'SetKeyValue'>>>>>>>({ kind: 'Err', value: TransactionRejectionReason.Validation.InstructionFailed.Evaluate.Unsupported.SetKeyValue }), RemoveKeyValue: Object.freeze<lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Evaluate', lib.Variant<'Unsupported', lib.VariantUnit<'RemoveKeyValue'>>>>>>>({ kind: 'Err', value: TransactionRejectionReason.Validation.InstructionFailed.Evaluate.Unsupported.RemoveKeyValue }), Grant: Object.freeze<lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Evaluate', lib.Variant<'Unsupported', lib.VariantUnit<'Grant'>>>>>>>({ kind: 'Err', value: TransactionRejectionReason.Validation.InstructionFailed.Evaluate.Unsupported.Grant }), Revoke: Object.freeze<lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Evaluate', lib.Variant<'Unsupported', lib.VariantUnit<'Revoke'>>>>>>>({ kind: 'Err', value: TransactionRejectionReason.Validation.InstructionFailed.Evaluate.Unsupported.Revoke }), ExecuteTrigger: Object.freeze<lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Evaluate', lib.Variant<'Unsupported', lib.VariantUnit<'ExecuteTrigger'>>>>>>>({ kind: 'Err', value: TransactionRejectionReason.Validation.InstructionFailed.Evaluate.Unsupported.ExecuteTrigger }), SetParameter: Object.freeze<lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Evaluate', lib.Variant<'Unsupported', lib.VariantUnit<'SetParameter'>>>>>>>({ kind: 'Err', value: TransactionRejectionReason.Validation.InstructionFailed.Evaluate.Unsupported.SetParameter }), Upgrade: Object.freeze<lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Evaluate', lib.Variant<'Unsupported', lib.VariantUnit<'Upgrade'>>>>>>>({ kind: 'Err', value: TransactionRejectionReason.Validation.InstructionFailed.Evaluate.Unsupported.Upgrade }), Log: Object.freeze<lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Evaluate', lib.Variant<'Unsupported', lib.VariantUnit<'Log'>>>>>>>({ kind: 'Err', value: TransactionRejectionReason.Validation.InstructionFailed.Evaluate.Unsupported.Log }), Custom: Object.freeze<lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Evaluate', lib.Variant<'Unsupported', lib.VariantUnit<'Custom'>>>>>>>({ kind: 'Err', value: TransactionRejectionReason.Validation.InstructionFailed.Evaluate.Unsupported.Custom }) }, PermissionParameter: <const T extends lib.String>(value: T): lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Evaluate', lib.Variant<'PermissionParameter', T>>>>> => ({ kind: 'Err', value: TransactionRejectionReason.Validation.InstructionFailed.Evaluate.PermissionParameter(value) }), Type: { AssetNumericSpec: <const T extends Mismatch<NumericSpec>>(value: T): lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Evaluate', lib.Variant<'Type', lib.Variant<'AssetNumericSpec', T>>>>>> => ({ kind: 'Err', value: TransactionRejectionReason.Validation.InstructionFailed.Evaluate.Type.AssetNumericSpec(value) }) } }, Query: { Find: { Asset: <const T extends lib.AssetId>(value: T): lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Query', lib.Variant<'Find', lib.Variant<'Asset', T>>>>>> => ({ kind: 'Err', value: TransactionRejectionReason.Validation.InstructionFailed.Query.Find.Asset(value) }), AssetDefinition: <const T extends lib.AssetDefinitionId>(value: T): lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Query', lib.Variant<'Find', lib.Variant<'AssetDefinition', T>>>>>> => ({ kind: 'Err', value: TransactionRejectionReason.Validation.InstructionFailed.Query.Find.AssetDefinition(value) }), Nft: <const T extends lib.NftId>(value: T): lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Query', lib.Variant<'Find', lib.Variant<'Nft', T>>>>>> => ({ kind: 'Err', value: TransactionRejectionReason.Validation.InstructionFailed.Query.Find.Nft(value) }), Account: <const T extends lib.AccountId>(value: T): lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Query', lib.Variant<'Find', lib.Variant<'Account', T>>>>>> => ({ kind: 'Err', value: TransactionRejectionReason.Validation.InstructionFailed.Query.Find.Account(value) }), Domain: <const T extends lib.DomainId>(value: T): lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Query', lib.Variant<'Find', lib.Variant<'Domain', T>>>>>> => ({ kind: 'Err', value: TransactionRejectionReason.Validation.InstructionFailed.Query.Find.Domain(value) }), MetadataKey: <const T extends lib.Name>(value: T): lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Query', lib.Variant<'Find', lib.Variant<'MetadataKey', T>>>>>> => ({ kind: 'Err', value: TransactionRejectionReason.Validation.InstructionFailed.Query.Find.MetadataKey(value) }), Block: <const T extends lib.Hash>(value: T): lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Query', lib.Variant<'Find', lib.Variant<'Block', T>>>>>> => ({ kind: 'Err', value: TransactionRejectionReason.Validation.InstructionFailed.Query.Find.Block(value) }), Transaction: <const T extends lib.Hash>(value: T): lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Query', lib.Variant<'Find', lib.Variant<'Transaction', T>>>>>> => ({ kind: 'Err', value: TransactionRejectionReason.Validation.InstructionFailed.Query.Find.Transaction(value) }), Peer: <const T extends PeerId>(value: T): lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Query', lib.Variant<'Find', lib.Variant<'Peer', T>>>>>> => ({ kind: 'Err', value: TransactionRejectionReason.Validation.InstructionFailed.Query.Find.Peer(value) }), Trigger: <const T extends TriggerId>(value: T): lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Query', lib.Variant<'Find', lib.Variant<'Trigger', T>>>>>> => ({ kind: 'Err', value: TransactionRejectionReason.Validation.InstructionFailed.Query.Find.Trigger(value) }), Role: <const T extends RoleId>(value: T): lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Query', lib.Variant<'Find', lib.Variant<'Role', T>>>>>> => ({ kind: 'Err', value: TransactionRejectionReason.Validation.InstructionFailed.Query.Find.Role(value) }), Permission: <const T extends Permission>(value: T): lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Query', lib.Variant<'Find', lib.Variant<'Permission', T>>>>>> => ({ kind: 'Err', value: TransactionRejectionReason.Validation.InstructionFailed.Query.Find.Permission(value) }), PublicKey: <const T extends lib.PublicKey>(value: T): lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Query', lib.Variant<'Find', lib.Variant<'PublicKey', T>>>>>> => ({ kind: 'Err', value: TransactionRejectionReason.Validation.InstructionFailed.Query.Find.PublicKey(value) }) }, Conversion: <const T extends lib.String>(value: T): lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Query', lib.Variant<'Conversion', T>>>>> => ({ kind: 'Err', value: TransactionRejectionReason.Validation.InstructionFailed.Query.Conversion(value) }), NotFound: Object.freeze<lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Query', lib.VariantUnit<'NotFound'>>>>>>({ kind: 'Err', value: TransactionRejectionReason.Validation.InstructionFailed.Query.NotFound }), CursorMismatch: Object.freeze<lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Query', lib.VariantUnit<'CursorMismatch'>>>>>>({ kind: 'Err', value: TransactionRejectionReason.Validation.InstructionFailed.Query.CursorMismatch }), CursorDone: Object.freeze<lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Query', lib.VariantUnit<'CursorDone'>>>>>>({ kind: 'Err', value: TransactionRejectionReason.Validation.InstructionFailed.Query.CursorDone }), FetchSizeTooBig: Object.freeze<lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Query', lib.VariantUnit<'FetchSizeTooBig'>>>>>>({ kind: 'Err', value: TransactionRejectionReason.Validation.InstructionFailed.Query.FetchSizeTooBig }), InvalidSingularParameters: Object.freeze<lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Query', lib.VariantUnit<'InvalidSingularParameters'>>>>>>({ kind: 'Err', value: TransactionRejectionReason.Validation.InstructionFailed.Query.InvalidSingularParameters }), CapacityLimit: Object.freeze<lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Query', lib.VariantUnit<'CapacityLimit'>>>>>>({ kind: 'Err', value: TransactionRejectionReason.Validation.InstructionFailed.Query.CapacityLimit }) }, Conversion: <const T extends lib.String>(value: T): lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Conversion', T>>>> => ({ kind: 'Err', value: TransactionRejectionReason.Validation.InstructionFailed.Conversion(value) }), Find: { Asset: <const T extends lib.AssetId>(value: T): lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Find', lib.Variant<'Asset', T>>>>> => ({ kind: 'Err', value: TransactionRejectionReason.Validation.InstructionFailed.Find.Asset(value) }), AssetDefinition: <const T extends lib.AssetDefinitionId>(value: T): lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Find', lib.Variant<'AssetDefinition', T>>>>> => ({ kind: 'Err', value: TransactionRejectionReason.Validation.InstructionFailed.Find.AssetDefinition(value) }), Nft: <const T extends lib.NftId>(value: T): lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Find', lib.Variant<'Nft', T>>>>> => ({ kind: 'Err', value: TransactionRejectionReason.Validation.InstructionFailed.Find.Nft(value) }), Account: <const T extends lib.AccountId>(value: T): lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Find', lib.Variant<'Account', T>>>>> => ({ kind: 'Err', value: TransactionRejectionReason.Validation.InstructionFailed.Find.Account(value) }), Domain: <const T extends lib.DomainId>(value: T): lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Find', lib.Variant<'Domain', T>>>>> => ({ kind: 'Err', value: TransactionRejectionReason.Validation.InstructionFailed.Find.Domain(value) }), MetadataKey: <const T extends lib.Name>(value: T): lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Find', lib.Variant<'MetadataKey', T>>>>> => ({ kind: 'Err', value: TransactionRejectionReason.Validation.InstructionFailed.Find.MetadataKey(value) }), Block: <const T extends lib.Hash>(value: T): lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Find', lib.Variant<'Block', T>>>>> => ({ kind: 'Err', value: TransactionRejectionReason.Validation.InstructionFailed.Find.Block(value) }), Transaction: <const T extends lib.Hash>(value: T): lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Find', lib.Variant<'Transaction', T>>>>> => ({ kind: 'Err', value: TransactionRejectionReason.Validation.InstructionFailed.Find.Transaction(value) }), Peer: <const T extends PeerId>(value: T): lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Find', lib.Variant<'Peer', T>>>>> => ({ kind: 'Err', value: TransactionRejectionReason.Validation.InstructionFailed.Find.Peer(value) }), Trigger: <const T extends TriggerId>(value: T): lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Find', lib.Variant<'Trigger', T>>>>> => ({ kind: 'Err', value: TransactionRejectionReason.Validation.InstructionFailed.Find.Trigger(value) }), Role: <const T extends RoleId>(value: T): lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Find', lib.Variant<'Role', T>>>>> => ({ kind: 'Err', value: TransactionRejectionReason.Validation.InstructionFailed.Find.Role(value) }), Permission: <const T extends Permission>(value: T): lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Find', lib.Variant<'Permission', T>>>>> => ({ kind: 'Err', value: TransactionRejectionReason.Validation.InstructionFailed.Find.Permission(value) }), PublicKey: <const T extends lib.PublicKey>(value: T): lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Find', lib.Variant<'PublicKey', T>>>>> => ({ kind: 'Err', value: TransactionRejectionReason.Validation.InstructionFailed.Find.PublicKey(value) }) }, Repetition: <const T extends RepetitionError>(value: T): lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Repetition', T>>>> => ({ kind: 'Err', value: TransactionRejectionReason.Validation.InstructionFailed.Repetition(value) }), Mintability: { MintUnmintable: Object.freeze<lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Mintability', lib.VariantUnit<'MintUnmintable'>>>>>>({ kind: 'Err', value: TransactionRejectionReason.Validation.InstructionFailed.Mintability.MintUnmintable }), ForbidMintOnMintable: Object.freeze<lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Mintability', lib.VariantUnit<'ForbidMintOnMintable'>>>>>>({ kind: 'Err', value: TransactionRejectionReason.Validation.InstructionFailed.Mintability.ForbidMintOnMintable }) }, Math: { Overflow: Object.freeze<lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Math', lib.VariantUnit<'Overflow'>>>>>>({ kind: 'Err', value: TransactionRejectionReason.Validation.InstructionFailed.Math.Overflow }), NotEnoughQuantity: Object.freeze<lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Math', lib.VariantUnit<'NotEnoughQuantity'>>>>>>({ kind: 'Err', value: TransactionRejectionReason.Validation.InstructionFailed.Math.NotEnoughQuantity }), DivideByZero: Object.freeze<lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Math', lib.VariantUnit<'DivideByZero'>>>>>>({ kind: 'Err', value: TransactionRejectionReason.Validation.InstructionFailed.Math.DivideByZero }), NegativeValue: Object.freeze<lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Math', lib.VariantUnit<'NegativeValue'>>>>>>({ kind: 'Err', value: TransactionRejectionReason.Validation.InstructionFailed.Math.NegativeValue }), DomainViolation: Object.freeze<lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Math', lib.VariantUnit<'DomainViolation'>>>>>>({ kind: 'Err', value: TransactionRejectionReason.Validation.InstructionFailed.Math.DomainViolation }), Unknown: Object.freeze<lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Math', lib.VariantUnit<'Unknown'>>>>>>({ kind: 'Err', value: TransactionRejectionReason.Validation.InstructionFailed.Math.Unknown }), FixedPointConversion: <const T extends lib.String>(value: T): lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'Math', lib.Variant<'FixedPointConversion', T>>>>> => ({ kind: 'Err', value: TransactionRejectionReason.Validation.InstructionFailed.Math.FixedPointConversion(value) }) }, InvalidParameter: { Wasm: <const T extends lib.String>(value: T): lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'InvalidParameter', lib.Variant<'Wasm', T>>>>> => ({ kind: 'Err', value: TransactionRejectionReason.Validation.InstructionFailed.InvalidParameter.Wasm(value) }), TimeTriggerInThePast: Object.freeze<lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'InvalidParameter', lib.VariantUnit<'TimeTriggerInThePast'>>>>>>({ kind: 'Err', value: TransactionRejectionReason.Validation.InstructionFailed.InvalidParameter.TimeTriggerInThePast }) }, InvariantViolation: <const T extends lib.String>(value: T): lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'InstructionFailed', lib.Variant<'InvariantViolation', T>>>> => ({ kind: 'Err', value: TransactionRejectionReason.Validation.InstructionFailed.InvariantViolation(value) }) }, QueryFailed: { Find: { Asset: <const T extends lib.AssetId>(value: T): lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'QueryFailed', lib.Variant<'Find', lib.Variant<'Asset', T>>>>> => ({ kind: 'Err', value: TransactionRejectionReason.Validation.QueryFailed.Find.Asset(value) }), AssetDefinition: <const T extends lib.AssetDefinitionId>(value: T): lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'QueryFailed', lib.Variant<'Find', lib.Variant<'AssetDefinition', T>>>>> => ({ kind: 'Err', value: TransactionRejectionReason.Validation.QueryFailed.Find.AssetDefinition(value) }), Nft: <const T extends lib.NftId>(value: T): lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'QueryFailed', lib.Variant<'Find', lib.Variant<'Nft', T>>>>> => ({ kind: 'Err', value: TransactionRejectionReason.Validation.QueryFailed.Find.Nft(value) }), Account: <const T extends lib.AccountId>(value: T): lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'QueryFailed', lib.Variant<'Find', lib.Variant<'Account', T>>>>> => ({ kind: 'Err', value: TransactionRejectionReason.Validation.QueryFailed.Find.Account(value) }), Domain: <const T extends lib.DomainId>(value: T): lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'QueryFailed', lib.Variant<'Find', lib.Variant<'Domain', T>>>>> => ({ kind: 'Err', value: TransactionRejectionReason.Validation.QueryFailed.Find.Domain(value) }), MetadataKey: <const T extends lib.Name>(value: T): lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'QueryFailed', lib.Variant<'Find', lib.Variant<'MetadataKey', T>>>>> => ({ kind: 'Err', value: TransactionRejectionReason.Validation.QueryFailed.Find.MetadataKey(value) }), Block: <const T extends lib.Hash>(value: T): lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'QueryFailed', lib.Variant<'Find', lib.Variant<'Block', T>>>>> => ({ kind: 'Err', value: TransactionRejectionReason.Validation.QueryFailed.Find.Block(value) }), Transaction: <const T extends lib.Hash>(value: T): lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'QueryFailed', lib.Variant<'Find', lib.Variant<'Transaction', T>>>>> => ({ kind: 'Err', value: TransactionRejectionReason.Validation.QueryFailed.Find.Transaction(value) }), Peer: <const T extends PeerId>(value: T): lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'QueryFailed', lib.Variant<'Find', lib.Variant<'Peer', T>>>>> => ({ kind: 'Err', value: TransactionRejectionReason.Validation.QueryFailed.Find.Peer(value) }), Trigger: <const T extends TriggerId>(value: T): lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'QueryFailed', lib.Variant<'Find', lib.Variant<'Trigger', T>>>>> => ({ kind: 'Err', value: TransactionRejectionReason.Validation.QueryFailed.Find.Trigger(value) }), Role: <const T extends RoleId>(value: T): lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'QueryFailed', lib.Variant<'Find', lib.Variant<'Role', T>>>>> => ({ kind: 'Err', value: TransactionRejectionReason.Validation.QueryFailed.Find.Role(value) }), Permission: <const T extends Permission>(value: T): lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'QueryFailed', lib.Variant<'Find', lib.Variant<'Permission', T>>>>> => ({ kind: 'Err', value: TransactionRejectionReason.Validation.QueryFailed.Find.Permission(value) }), PublicKey: <const T extends lib.PublicKey>(value: T): lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'QueryFailed', lib.Variant<'Find', lib.Variant<'PublicKey', T>>>>> => ({ kind: 'Err', value: TransactionRejectionReason.Validation.QueryFailed.Find.PublicKey(value) }) }, Conversion: <const T extends lib.String>(value: T): lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'QueryFailed', lib.Variant<'Conversion', T>>>> => ({ kind: 'Err', value: TransactionRejectionReason.Validation.QueryFailed.Conversion(value) }), NotFound: Object.freeze<lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'QueryFailed', lib.VariantUnit<'NotFound'>>>>>({ kind: 'Err', value: TransactionRejectionReason.Validation.QueryFailed.NotFound }), CursorMismatch: Object.freeze<lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'QueryFailed', lib.VariantUnit<'CursorMismatch'>>>>>({ kind: 'Err', value: TransactionRejectionReason.Validation.QueryFailed.CursorMismatch }), CursorDone: Object.freeze<lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'QueryFailed', lib.VariantUnit<'CursorDone'>>>>>({ kind: 'Err', value: TransactionRejectionReason.Validation.QueryFailed.CursorDone }), FetchSizeTooBig: Object.freeze<lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'QueryFailed', lib.VariantUnit<'FetchSizeTooBig'>>>>>({ kind: 'Err', value: TransactionRejectionReason.Validation.QueryFailed.FetchSizeTooBig }), InvalidSingularParameters: Object.freeze<lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'QueryFailed', lib.VariantUnit<'InvalidSingularParameters'>>>>>({ kind: 'Err', value: TransactionRejectionReason.Validation.QueryFailed.InvalidSingularParameters }), CapacityLimit: Object.freeze<lib.Variant<'Err', lib.Variant<'Validation', lib.Variant<'QueryFailed', lib.VariantUnit<'CapacityLimit'>>>>>({ kind: 'Err', value: TransactionRejectionReason.Validation.QueryFailed.CapacityLimit }) }, TooComplex: Object.freeze<lib.Variant<'Err', lib.Variant<'Validation', lib.VariantUnit<'TooComplex'>>>>({ kind: 'Err', value: TransactionRejectionReason.Validation.TooComplex }), InternalError: Object.freeze<lib.Variant<'Err', lib.Variant<'Validation', lib.VariantUnit<'InternalError'>>>>({ kind: 'Err', value: TransactionRejectionReason.Validation.InternalError }) }, InstructionExecution: <const T extends InstructionExecutionFail>(value: T): lib.Variant<'Err', lib.Variant<'InstructionExecution', T>> => ({ kind: 'Err', value: TransactionRejectionReason.InstructionExecution(value) }), WasmExecution: <const T extends WasmExecutionFail>(value: T): lib.Variant<'Err', lib.Variant<'WasmExecution', T>> => ({ kind: 'Err', value: TransactionRejectionReason.WasmExecution(value) }), TriggerExecution: { MaxDepthExceeded: Object.freeze<lib.Variant<'Err', lib.Variant<'TriggerExecution', lib.VariantUnit<'MaxDepthExceeded'>>>>({ kind: 'Err', value: TransactionRejectionReason.TriggerExecution.MaxDepthExceeded }) } } }, ...lib.defineCodec(lib.enumCodec<{ Ok: [lib.Vec<DataTriggerStep>], Err: [TransactionRejectionReason] }>({ Ok: [0, lib.Vec.with(lib.getCodec(DataTriggerStep))], Err: [1, lib.getCodec(TransactionRejectionReason)] }).discriminated()) }

/**
 * Structure with named fields.
 */
export interface BlockResult { timeTriggers: lib.Vec<TimeTriggerEntrypoint>, merkle: MerkleTree, resultMerkle: MerkleTree, transactionResults: lib.Vec<TransactionResult> }
/**
 * Codec of the structure.
 */
export const BlockResult: lib.CodecContainer<BlockResult> = lib.defineCodec(lib.structCodec<BlockResult>(['timeTriggers', 'merkle', 'resultMerkle', 'transactionResults'], {timeTriggers: lib.Vec.with(lib.getCodec(TimeTriggerEntrypoint)), merkle: lib.getCodec(MerkleTree), resultMerkle: lib.getCodec(MerkleTree), transactionResults: lib.Vec.with(lib.getCodec(TransactionResult))}))

/**
 * Structure with named fields.
 */
export interface BlockSubscriptionRequest { height: lib.NonZero<lib.U64> }
/**
 * Codec of the structure.
 */
export const BlockSubscriptionRequest: lib.CodecContainer<BlockSubscriptionRequest> = lib.defineCodec(lib.structCodec<BlockSubscriptionRequest>(['height'], {height: lib.NonZero.with(lib.getCodec(lib.U64))}))

/**
 * Structure with named fields.
 */
export interface SignedBlockV1 { signatures: lib.BTreeSet<lib.BlockSignature>, payload: BlockPayload, result: BlockResult }
/**
 * Codec of the structure.
 */
export const SignedBlockV1: lib.CodecContainer<SignedBlockV1> = lib.defineCodec(lib.structCodec<SignedBlockV1>(['signatures', 'payload', 'result'], {signatures: lib.BTreeSet.with(lib.getCodec(lib.BlockSignature)), payload: lib.getCodec(BlockPayload), result: lib.getCodec(BlockResult)}))
 ...
 * TODO how to construct, how to use
 */
export type BlockStreamMessage = lib.Variant<'Subscribe', BlockSubscriptionRequest> | lib.VariantUnit<'Next'> | lib.Variant<'Block', SignedBlock>
/**
 * Codec and constructors for enumeration {@link BlockStreamMessage}.
 */
export const BlockStreamMessage: lib.CodecContainer<BlockStreamMessage> & { Subscribe: <const T extends BlockSubscriptionRequest>(value: T) => lib.Variant<'Subscribe', T>, Next: lib.VariantUnit<'Next'>, Block: { V1: <const T extends SignedBlockV1>(value: T) => lib.Variant<'Block', lib.Variant<'V1', T>> } } = { ...{ Subscribe: <const T extends BlockSubscriptionRequest>(value: T): lib.Variant<'Subscribe', T> => ({ kind: 'Subscribe', value }), Next: Object.freeze({ kind: 'Next' }), Block: { V1: <const T extends SignedBlockV1>(value: T): lib.Variant<'Block', lib.Variant<'V1', T>> => ({ kind: 'Block', value: SignedBlock.V1(value) }) } }, ...lib.defineCodec(lib.enumCodec<{ Subscribe: [BlockSubscriptionRequest], Next: [], Block: [SignedBlock] }>({ Subscribe: [0, lib.getCodec(BlockSubscriptionRequest)], Next: [1], Block: [2, lib.getCodec(SignedBlock)] }).discriminated()) }
 ...
 * Structure with named fields.
 */
export interface MerkleProof { leafIndex: lib.U32, auditPath: lib.Vec<lib.Option<lib.Hash>> }
/**
 * Codec of the structure.
 */
export const MerkleProof: lib.CodecContainer<MerkleProof> = lib.defineCodec(lib.structCodec<MerkleProof>(['leafIndex', 'auditPath'], {leafIndex: lib.getCodec(lib.U32), auditPath: lib.Vec.with(lib.Option.with(lib.getCodec(lib.Hash)))}))
 ...
 * TODO how to construct, how to use
 */
export type TransactionEntrypoint = lib.Variant<'External', SignedTransaction> | lib.Variant<'Time', TimeTriggerEntrypoint>
/**
 * Codec and constructors for enumeration {@link TransactionEntrypoint}.
 */
export const TransactionEntrypoint: lib.CodecContainer<TransactionEntrypoint> & { External: { V1: <const T extends SignedTransactionV1>(value: T) => lib.Variant<'External', lib.Variant<'V1', T>> }, Time: <const T extends TimeTriggerEntrypoint>(value: T) => lib.Variant<'Time', T> } = { ...{ External: { V1: <const T extends SignedTransactionV1>(value: T): lib.Variant<'External', lib.Variant<'V1', T>> => ({ kind: 'External', value: SignedTransaction.V1(value) }) }, Time: <const T extends TimeTriggerEntrypoint>(value: T): lib.Variant<'Time', T> => ({ kind: 'Time', value }) }, ...lib.defineCodec(lib.enumCodec<{ External: [SignedTransaction], Time: [TimeTriggerEntrypoint] }>({ External: [0, lib.getCodec(SignedTransaction)], Time: [1, lib.getCodec(TimeTriggerEntrypoint)] }).discriminated()) }

/**
 * Structure with named fields.
 */
export interface CommittedTransaction { blockHash: lib.Hash, entrypointHash: lib.Hash, entrypointProof: MerkleProof, entrypoint: TransactionEntrypoint, resultHash: lib.Hash, resultProof: MerkleProof, result: TransactionResult }
/**
 * Codec of the structure.
 */
export const CommittedTransaction: lib.CodecContainer<CommittedTransaction> = lib.defineCodec(lib.structCodec<CommittedTransaction>(['blockHash', 'entrypointHash', 'entrypointProof', 'entrypoint', 'resultHash', 'resultProof', 'result'], {blockHash: lib.getCodec(lib.Hash), entrypointHash: lib.getCodec(lib.Hash), entrypointProof: lib.getCodec(MerkleProof), entrypoint: lib.getCodec(TransactionEntrypoint), resultHash: lib.getCodec(lib.Hash), resultProof: lib.getCodec(MerkleProof), result: lib.getCodec(TransactionResult)}))
 ...
 * TODO how to construct, how to use
 */
export type TransactionEntrypointHashPredicateAtom = lib.Variant<'Equals', lib.Hash>
/**
 * Codec and constructors for enumeration {@link TransactionEntrypointHashPredicateAtom}.
 */
export const TransactionEntrypointHashPredicateAtom: lib.CodecContainer<TransactionEntrypointHashPredicateAtom> & { Equals: <const T extends lib.Hash>(value: T) => lib.Variant<'Equals', T> } = { ...{ Equals: <const T extends lib.Hash>(value: T): lib.Variant<'Equals', T> => ({ kind: 'Equals', value }) }, ...lib.defineCodec(lib.enumCodec<{ Equals: [lib.Hash] }>({ Equals: [0, lib.getCodec(lib.Hash)] }).discriminated()) }
 ...
 * TODO how to construct, how to use
 */
export type TransactionEntrypointHashProjectionPredicate = lib.Variant<'Atom', TransactionEntrypointHashPredicateAtom>
/**
 * Codec and constructors for enumeration {@link TransactionEntrypointHashProjectionPredicate}.
 */
export const TransactionEntrypointHashProjectionPredicate: lib.CodecContainer<TransactionEntrypointHashProjectionPredicate> & { Atom: { Equals: <const T extends lib.Hash>(value: T) => lib.Variant<'Atom', lib.Variant<'Equals', T>> } } = { ...{ Atom: { Equals: <const T extends lib.Hash>(value: T): lib.Variant<'Atom', lib.Variant<'Equals', T>> => ({ kind: 'Atom', value: TransactionEntrypointHashPredicateAtom.Equals(value) }) } }, ...lib.defineCodec(lib.enumCodec<{ Atom: [TransactionEntrypointHashPredicateAtom] }>({ Atom: [0, lib.getCodec(TransactionEntrypointHashPredicateAtom)] }).discriminated()) }
 ...
 * TODO how to construct, how to use
 */
export type TransactionEntrypointPredicateAtom = lib.VariantUnit<'IsExternal'>
/**
 * Codec and constructors for enumeration {@link TransactionEntrypointPredicateAtom}.
 */
export const TransactionEntrypointPredicateAtom: lib.CodecContainer<TransactionEntrypointPredicateAtom> & { IsExternal: lib.VariantUnit<'IsExternal'> } = { ...{ IsExternal: Object.freeze({ kind: 'IsExternal' }) }, ...lib.defineCodec(lib.enumCodec<{ IsExternal: [] }>({ IsExternal: [0] }).discriminated()) }
 ...
 * TODO how to construct, how to use
 */
export type TransactionEntrypointProjectionPredicate = lib.Variant<'Atom', TransactionEntrypointPredicateAtom> | lib.Variant<'Authority', AccountIdProjectionPredicate>
/**
 * Codec and constructors for enumeration {@link TransactionEntrypointProjectionPredicate}.
 */
export const TransactionEntrypointProjectionPredicate: lib.CodecContainer<TransactionEntrypointProjectionPredicate> & { Atom: { IsExternal: lib.Variant<'Atom', lib.VariantUnit<'IsExternal'>> }, Authority: { Atom: { Equals: <const T extends lib.AccountId>(value: T) => lib.Variant<'Authority', lib.Variant<'Atom', lib.Variant<'Equals', T>>> }, Domain: { Atom: { Equals: <const T extends lib.DomainId>(value: T) => lib.Variant<'Authority', lib.Variant<'Domain', lib.Variant<'Atom', lib.Variant<'Equals', T>>>> }, Name: { Atom: { Equals: <const T extends lib.String>(value: T) => lib.Variant<'Authority', lib.Variant<'Domain', lib.Variant<'Name', lib.Variant<'Atom', lib.Variant<'Equals', T>>>>>, Contains: <const T extends lib.String>(value: T) => lib.Variant<'Authority', lib.Variant<'Domain', lib.Variant<'Name', lib.Variant<'Atom', lib.Variant<'Contains', T>>>>>, StartsWith: <const T extends lib.String>(value: T) => lib.Variant<'Authority', lib.Variant<'Domain', lib.Variant<'Name', lib.Variant<'Atom', lib.Variant<'StartsWith', T>>>>>, EndsWith: <const T extends lib.String>(value: T) => lib.Variant<'Authority', lib.Variant<'Domain', lib.Variant<'Name', lib.Variant<'Atom', lib.Variant<'EndsWith', T>>>>> } } }, Signatory: { Atom: { Equals: <const T extends lib.PublicKey>(value: T) => lib.Variant<'Authority', lib.Variant<'Signatory', lib.Variant<'Atom', lib.Variant<'Equals', T>>>> } } } } = { ...{ Atom: { IsExternal: Object.freeze<lib.Variant<'Atom', lib.VariantUnit<'IsExternal'>>>({ kind: 'Atom', value: TransactionEntrypointPredicateAtom.IsExternal }) }, Authority: { Atom: { Equals: <const T extends lib.AccountId>(value: T): lib.Variant<'Authority', lib.Variant<'Atom', lib.Variant<'Equals', T>>> => ({ kind: 'Authority', value: AccountIdProjectionPredicate.Atom.Equals(value) }) }, Domain: { Atom: { Equals: <const T extends lib.DomainId>(value: T): lib.Variant<'Authority', lib.Variant<'Domain', lib.Variant<'Atom', lib.Variant<'Equals', T>>>> => ({ kind: 'Authority', value: AccountIdProjectionPredicate.Domain.Atom.Equals(value) }) }, Name: { Atom: { Equals: <const T extends lib.String>(value: T): lib.Variant<'Authority', lib.Variant<'Domain', lib.Variant<'Name', lib.Variant<'Atom', lib.Variant<'Equals', T>>>>> => ({ kind: 'Authority', value: AccountIdProjectionPredicate.Domain.Name.Atom.Equals(value) }), Contains: <const T extends lib.String>(value: T): lib.Variant<'Authority', lib.Variant<'Domain', lib.Variant<'Name', lib.Variant<'Atom', lib.Variant<'Contains', T>>>>> => ({ kind: 'Authority', value: AccountIdProjectionPredicate.Domain.Name.Atom.Contains(value) }), StartsWith: <const T extends lib.String>(value: T): lib.Variant<'Authority', lib.Variant<'Domain', lib.Variant<'Name', lib.Variant<'Atom', lib.Variant<'StartsWith', T>>>>> => ({ kind: 'Authority', value: AccountIdProjectionPredicate.Domain.Name.Atom.StartsWith(value) }), EndsWith: <const T extends lib.String>(value: T): lib.Variant<'Authority', lib.Variant<'Domain', lib.Variant<'Name', lib.Variant<'Atom', lib.Variant<'EndsWith', T>>>>> => ({ kind: 'Authority', value: AccountIdProjectionPredicate.Domain.Name.Atom.EndsWith(value) }) } } }, Signatory: { Atom: { Equals: <const T extends lib.PublicKey>(value: T): lib.Variant<'Authority', lib.Variant<'Signatory', lib.Variant<'Atom', lib.Variant<'Equals', T>>>> => ({ kind: 'Authority', value: AccountIdProjectionPredicate.Signatory.Atom.Equals(value) }) } } } }, ...lib.defineCodec(lib.enumCodec<{ Atom: [TransactionEntrypointPredicateAtom], Authority: [AccountIdProjectionPredicate] }>({ Atom: [0, lib.getCodec(TransactionEntrypointPredicateAtom)], Authority: [1, lib.getCodec(AccountIdProjectionPredicate)] }).discriminated()) }
 ...
 * TODO how to construct, how to use
 */
export type TransactionResultHashPredicateAtom = lib.Variant<'Equals', lib.Hash>
/**
 * Codec and constructors for enumeration {@link TransactionResultHashPredicateAtom}.
 */
export const TransactionResultHashPredicateAtom: lib.CodecContainer<TransactionResultHashPredicateAtom> & { Equals: <const T extends lib.Hash>(value: T) => lib.Variant<'Equals', T> } = { ...{ Equals: <const T extends lib.Hash>(value: T): lib.Variant<'Equals', T> => ({ kind: 'Equals', value }) }, ...lib.defineCodec(lib.enumCodec<{ Equals: [lib.Hash] }>({ Equals: [0, lib.getCodec(lib.Hash)] }).discriminated()) }
 ...
 * TODO how to construct, how to use
 */
export type TransactionResultHashProjectionPredicate = lib.Variant<'Atom', TransactionResultHashPredicateAtom>
/**
 * Codec and constructors for enumeration {@link TransactionResultHashProjectionPredicate}.
 */
export const TransactionResultHashProjectionPredicate: lib.CodecContainer<TransactionResultHashProjectionPredicate> & { Atom: { Equals: <const T extends lib.Hash>(value: T) => lib.Variant<'Atom', lib.Variant<'Equals', T>> } } = { ...{ Atom: { Equals: <const T extends lib.Hash>(value: T): lib.Variant<'Atom', lib.Variant<'Equals', T>> => ({ kind: 'Atom', value: TransactionResultHashPredicateAtom.Equals(value) }) } }, ...lib.defineCodec(lib.enumCodec<{ Atom: [TransactionResultHashPredicateAtom] }>({ Atom: [0, lib.getCodec(TransactionResultHashPredicateAtom)] }).discriminated()) }
 ...
 * TODO how to construct, how to use
 */
export type TransactionResultPredicateAtom = lib.VariantUnit<'IsOk'> | lib.Variant<'ContainsDataTrigger', TriggerId>
/**
 * Codec and constructors for enumeration {@link TransactionResultPredicateAtom}.
 */
export const TransactionResultPredicateAtom: lib.CodecContainer<TransactionResultPredicateAtom> & { IsOk: lib.VariantUnit<'IsOk'>, ContainsDataTrigger: <const T extends TriggerId>(value: T) => lib.Variant<'ContainsDataTrigger', T> } = { ...{ IsOk: Object.freeze({ kind: 'IsOk' }), ContainsDataTrigger: <const T extends TriggerId>(value: T): lib.Variant<'ContainsDataTrigger', T> => ({ kind: 'ContainsDataTrigger', value }) }, ...lib.defineCodec(lib.enumCodec<{ IsOk: [], ContainsDataTrigger: [TriggerId] }>({ IsOk: [0], ContainsDataTrigger: [1, lib.getCodec(TriggerId)] }).discriminated()) }
 ...
 * TODO how to construct, how to use
 */
export type TransactionResultProjectionPredicate = lib.Variant<'Atom', TransactionResultPredicateAtom>
/**
 * Codec and constructors for enumeration {@link TransactionResultProjectionPredicate}.
 */
export const TransactionResultProjectionPredicate: lib.CodecContainer<TransactionResultProjectionPredicate> & { Atom: { IsOk: lib.Variant<'Atom', lib.VariantUnit<'IsOk'>>, ContainsDataTrigger: <const T extends TriggerId>(value: T) => lib.Variant<'Atom', lib.Variant<'ContainsDataTrigger', T>> } } = { ...{ Atom: { IsOk: Object.freeze<lib.Variant<'Atom', lib.VariantUnit<'IsOk'>>>({ kind: 'Atom', value: TransactionResultPredicateAtom.IsOk }), ContainsDataTrigger: <const T extends TriggerId>(value: T): lib.Variant<'Atom', lib.Variant<'ContainsDataTrigger', T>> => ({ kind: 'Atom', value: TransactionResultPredicateAtom.ContainsDataTrigger(value) }) } }, ...lib.defineCodec(lib.enumCodec<{ Atom: [TransactionResultPredicateAtom] }>({ Atom: [0, lib.getCodec(TransactionResultPredicateAtom)] }).discriminated()) }
 ...
 * TODO how to construct, how to use
 */
export type CommittedTransactionProjectionPredicate = lib.Variant<'Atom', CommittedTransactionPredicateAtom> | lib.Variant<'BlockHash', BlockHeaderHashProjectionPredicate> | lib.Variant<'TransactionEntrypointHash', TransactionEntrypointHashProjectionPredicate> | lib.Variant<'TransactionEntrypoint', TransactionEntrypointProjectionPredicate> | lib.Variant<'TransactionResultHash', TransactionResultHashProjectionPredicate> | lib.Variant<'TransactionResult', TransactionResultProjectionPredicate>
/**
 * Codec and constructors for enumeration {@link CommittedTransactionProjectionPredicate}.
 */
export const CommittedTransactionProjectionPredicate: lib.CodecContainer<CommittedTransactionProjectionPredicate> & { BlockHash: { Atom: { Equals: <const T extends lib.Hash>(value: T) => lib.Variant<'BlockHash', lib.Variant<'Atom', lib.Variant<'Equals', T>>> } }, TransactionEntrypointHash: { Atom: { Equals: <const T extends lib.Hash>(value: T) => lib.Variant<'TransactionEntrypointHash', lib.Variant<'Atom', lib.Variant<'Equals', T>>> } }, TransactionEntrypoint: { Atom: { IsExternal: lib.Variant<'TransactionEntrypoint', lib.Variant<'Atom', lib.VariantUnit<'IsExternal'>>> }, Authority: { Atom: { Equals: <const T extends lib.AccountId>(value: T) => lib.Variant<'TransactionEntrypoint', lib.Variant<'Authority', lib.Variant<'Atom', lib.Variant<'Equals', T>>>> }, Domain: { Atom: { Equals: <const T extends lib.DomainId>(value: T) => lib.Variant<'TransactionEntrypoint', lib.Variant<'Authority', lib.Variant<'Domain', lib.Variant<'Atom', lib.Variant<'Equals', T>>>>> }, Name: { Atom: { Equals: <const T extends lib.String>(value: T) => lib.Variant<'TransactionEntrypoint', lib.Variant<'Authority', lib.Variant<'Domain', lib.Variant<'Name', lib.Variant<'Atom', lib.Variant<'Equals', T>>>>>>, Contains: <const T extends lib.String>(value: T) => lib.Variant<'TransactionEntrypoint', lib.Variant<'Authority', lib.Variant<'Domain', lib.Variant<'Name', lib.Variant<'Atom', lib.Variant<'Contains', T>>>>>>, StartsWith: <const T extends lib.String>(value: T) => lib.Variant<'TransactionEntrypoint', lib.Variant<'Authority', lib.Variant<'Domain', lib.Variant<'Name', lib.Variant<'Atom', lib.Variant<'StartsWith', T>>>>>>, EndsWith: <const T extends lib.String>(value: T) => lib.Variant<'TransactionEntrypoint', lib.Variant<'Authority', lib.Variant<'Domain', lib.Variant<'Name', lib.Variant<'Atom', lib.Variant<'EndsWith', T>>>>>> } } }, Signatory: { Atom: { Equals: <const T extends lib.PublicKey>(value: T) => lib.Variant<'TransactionEntrypoint', lib.Variant<'Authority', lib.Variant<'Signatory', lib.Variant<'Atom', lib.Variant<'Equals', T>>>>> } } } }, TransactionResultHash: { Atom: { Equals: <const T extends lib.Hash>(value: T) => lib.Variant<'TransactionResultHash', lib.Variant<'Atom', lib.Variant<'Equals', T>>> } }, TransactionResult: { Atom: { IsOk: lib.Variant<'TransactionResult', lib.Variant<'Atom', lib.VariantUnit<'IsOk'>>>, ContainsDataTrigger: <const T extends TriggerId>(value: T) => lib.Variant<'TransactionResult', lib.Variant<'Atom', lib.Variant<'ContainsDataTrigger', T>>> } } } = { ...{ BlockHash: { Atom: { Equals: <const T extends lib.Hash>(value: T): lib.Variant<'BlockHash', lib.Variant<'Atom', lib.Variant<'Equals', T>>> => ({ kind: 'BlockHash', value: BlockHeaderHashProjectionPredicate.Atom.Equals(value) }) } }, TransactionEntrypointHash: { Atom: { Equals: <const T extends lib.Hash>(value: T): lib.Variant<'TransactionEntrypointHash', lib.Variant<'Atom', lib.Variant<'Equals', T>>> => ({ kind: 'TransactionEntrypointHash', value: TransactionEntrypointHashProjectionPredicate.Atom.Equals(value) }) } }, TransactionEntrypoint: { Atom: { IsExternal: Object.freeze<lib.Variant<'TransactionEntrypoint', lib.Variant<'Atom', lib.VariantUnit<'IsExternal'>>>>({ kind: 'TransactionEntrypoint', value: TransactionEntrypointProjectionPredicate.Atom.IsExternal }) }, Authority: { Atom: { Equals: <const T extends lib.AccountId>(value: T): lib.Variant<'TransactionEntrypoint', lib.Variant<'Authority', lib.Variant<'Atom', lib.Variant<'Equals', T>>>> => ({ kind: 'TransactionEntrypoint', value: TransactionEntrypointProjectionPredicate.Authority.Atom.Equals(value) }) }, Domain: { Atom: { Equals: <const T extends lib.DomainId>(value: T): lib.Variant<'TransactionEntrypoint', lib.Variant<'Authority', lib.Variant<'Domain', lib.Variant<'Atom', lib.Variant<'Equals', T>>>>> => ({ kind: 'TransactionEntrypoint', value: TransactionEntrypointProjectionPredicate.Authority.Domain.Atom.Equals(value) }) }, Name: { Atom: { Equals: <const T extends lib.String>(value: T): lib.Variant<'TransactionEntrypoint', lib.Variant<'Authority', lib.Variant<'Domain', lib.Variant<'Name', lib.Variant<'Atom', lib.Variant<'Equals', T>>>>>> => ({ kind: 'TransactionEntrypoint', value: TransactionEntrypointProjectionPredicate.Authority.Domain.Name.Atom.Equals(value) }), Contains: <const T extends lib.String>(value: T): lib.Variant<'TransactionEntrypoint', lib.Variant<'Authority', lib.Variant<'Domain', lib.Variant<'Name', lib.Variant<'Atom', lib.Variant<'Contains', T>>>>>> => ({ kind: 'TransactionEntrypoint', value: TransactionEntrypointProjectionPredicate.Authority.Domain.Name.Atom.Contains(value) }), StartsWith: <const T extends lib.String>(value: T): lib.Variant<'TransactionEntrypoint', lib.Variant<'Authority', lib.Variant<'Domain', lib.Variant<'Name', lib.Variant<'Atom', lib.Variant<'StartsWith', T>>>>>> => ({ kind: 'TransactionEntrypoint', value: TransactionEntrypointProjectionPredicate.Authority.Domain.Name.Atom.StartsWith(value) }), EndsWith: <const T extends lib.String>(value: T): lib.Variant<'TransactionEntrypoint', lib.Variant<'Authority', lib.Variant<'Domain', lib.Variant<'Name', lib.Variant<'Atom', lib.Variant<'EndsWith', T>>>>>> => ({ kind: 'TransactionEntrypoint', value: TransactionEntrypointProjectionPredicate.Authority.Domain.Name.Atom.EndsWith(value) }) } } }, Signatory: { Atom: { Equals: <const T extends lib.PublicKey>(value: T): lib.Variant<'TransactionEntrypoint', lib.Variant<'Authority', lib.Variant<'Signatory', lib.Variant<'Atom', lib.Variant<'Equals', T>>>>> => ({ kind: 'TransactionEntrypoint', value: TransactionEntrypointProjectionPredicate.Authority.Signatory.Atom.Equals(value) }) } } } }, TransactionResultHash: { Atom: { Equals: <const T extends lib.Hash>(value: T): lib.Variant<'TransactionResultHash', lib.Variant<'Atom', lib.Variant<'Equals', T>>> => ({ kind: 'TransactionResultHash', value: TransactionResultHashProjectionPredicate.Atom.Equals(value) }) } }, TransactionResult: { Atom: { IsOk: Object.freeze<lib.Variant<'TransactionResult', lib.Variant<'Atom', lib.VariantUnit<'IsOk'>>>>({ kind: 'TransactionResult', value: TransactionResultProjectionPredicate.Atom.IsOk }), ContainsDataTrigger: <const T extends TriggerId>(value: T): lib.Variant<'TransactionResult', lib.Variant<'Atom', lib.Variant<'ContainsDataTrigger', T>>> => ({ kind: 'TransactionResult', value: TransactionResultProjectionPredicate.Atom.ContainsDataTrigger(value) }) } } }, ...lib.defineCodec(lib.enumCodec<{ Atom: [CommittedTransactionPredicateAtom], BlockHash: [BlockHeaderHashProjectionPredicate], TransactionEntrypointHash: [TransactionEntrypointHashProjectionPredicate], TransactionEntrypoint: [TransactionEntrypointProjectionPredicate], TransactionResultHash: [TransactionResultHashProjectionPredicate], TransactionResult: [TransactionResultProjectionPredicate] }>({ Atom: [0, lib.getCodec(CommittedTransactionPredicateAtom)], BlockHash: [1, lib.getCodec(BlockHeaderHashProjectionPredicate)], TransactionEntrypointHash: [2, lib.getCodec(TransactionEntrypointHashProjectionPredicate)], TransactionEntrypoint: [3, lib.getCodec(TransactionEntrypointProjectionPredicate)], TransactionResultHash: [4, lib.getCodec(TransactionResultHashProjectionPredicate)], TransactionResult: [5, lib.getCodec(TransactionResultProjectionPredicate)] }).discriminated()) }
 ...
 * TODO how to construct, how to use
 */
export type TransactionEntrypointHashProjectionSelector = lib.VariantUnit<'Atom'>
/**
 * Codec and constructors for enumeration {@link TransactionEntrypointHashProjectionSelector}.
 */
export const TransactionEntrypointHashProjectionSelector: lib.CodecContainer<TransactionEntrypointHashProjectionSelector> & { Atom: lib.VariantUnit<'Atom'> } = { ...{ Atom: Object.freeze({ kind: 'Atom' }) }, ...lib.defineCodec(lib.enumCodec<{ Atom: [] }>({ Atom: [0] }).discriminated()) }
 ...
 * TODO how to construct, how to use
 */
export type TransactionEntrypointProjectionSelector = lib.VariantUnit<'Atom'> | lib.Variant<'Authority', AccountIdProjectionSelector>
/**
 * Codec and constructors for enumeration {@link TransactionEntrypointProjectionSelector}.
 */
export const TransactionEntrypointProjectionSelector: lib.CodecContainer<TransactionEntrypointProjectionSelector> & { Atom: lib.VariantUnit<'Atom'>, Authority: { Atom: lib.Variant<'Authority', lib.VariantUnit<'Atom'>>, Domain: { Atom: lib.Variant<'Authority', lib.Variant<'Domain', lib.VariantUnit<'Atom'>>>, Name: { Atom: lib.Variant<'Authority', lib.Variant<'Domain', lib.Variant<'Name', lib.VariantUnit<'Atom'>>>> } }, Signatory: { Atom: lib.Variant<'Authority', lib.Variant<'Signatory', lib.VariantUnit<'Atom'>>> } } } = { ...{ Atom: Object.freeze({ kind: 'Atom' }), Authority: { Atom: Object.freeze<lib.Variant<'Authority', lib.VariantUnit<'Atom'>>>({ kind: 'Authority', value: AccountIdProjectionSelector.Atom }), Domain: { Atom: Object.freeze<lib.Variant<'Authority', lib.Variant<'Domain', lib.VariantUnit<'Atom'>>>>({ kind: 'Authority', value: AccountIdProjectionSelector.Domain.Atom }), Name: { Atom: Object.freeze<lib.Variant<'Authority', lib.Variant<'Domain', lib.Variant<'Name', lib.VariantUnit<'Atom'>>>>>({ kind: 'Authority', value: AccountIdProjectionSelector.Domain.Name.Atom }) } }, Signatory: { Atom: Object.freeze<lib.Variant<'Authority', lib.Variant<'Signatory', lib.VariantUnit<'Atom'>>>>({ kind: 'Authority', value: AccountIdProjectionSelector.Signatory.Atom }) } } }, ...lib.defineCodec(lib.enumCodec<{ Atom: [], Authority: [AccountIdProjectionSelector] }>({ Atom: [0], Authority: [1, lib.getCodec(AccountIdProjectionSelector)] }).discriminated()) }
 ...
 * TODO how to construct, how to use
 */
export type TransactionResultHashProjectionSelector = lib.VariantUnit<'Atom'>
/**
 * Codec and constructors for enumeration {@link TransactionResultHashProjectionSelector}.
 */
export const TransactionResultHashProjectionSelector: lib.CodecContainer<TransactionResultHashProjectionSelector> & { Atom: lib.VariantUnit<'Atom'> } = { ...{ Atom: Object.freeze({ kind: 'Atom' }) }, ...lib.defineCodec(lib.enumCodec<{ Atom: [] }>({ Atom: [0] }).discriminated()) }
 ...
 * TODO how to construct, how to use
 */
export type TransactionResultProjectionSelector = lib.VariantUnit<'Atom'>
/**
 * Codec and constructors for enumeration {@link TransactionResultProjectionSelector}.
 */
export const TransactionResultProjectionSelector: lib.CodecContainer<TransactionResultProjectionSelector> & { Atom: lib.VariantUnit<'Atom'> } = { ...{ Atom: Object.freeze({ kind: 'Atom' }) }, ...lib.defineCodec(lib.enumCodec<{ Atom: [] }>({ Atom: [0] }).discriminated()) }
 ...
 * TODO how to construct, how to use
 */
export type CommittedTransactionProjectionSelector = lib.VariantUnit<'Atom'> | lib.Variant<'BlockHash', BlockHeaderHashProjectionSelector> | lib.Variant<'TransactionEntrypointHash', TransactionEntrypointHashProjectionSelector> | lib.Variant<'TransactionEntrypoint', TransactionEntrypointProjectionSelector> | lib.Variant<'TransactionResultHash', TransactionResultHashProjectionSelector> | lib.Variant<'TransactionResult', TransactionResultProjectionSelector>
/**
 * Codec and constructors for enumeration {@link CommittedTransactionProjectionSelector}.
 */
export const CommittedTransactionProjectionSelector: lib.CodecContainer<CommittedTransactionProjectionSelector> & { Atom: lib.VariantUnit<'Atom'>, BlockHash: { Atom: lib.Variant<'BlockHash', lib.VariantUnit<'Atom'>> }, TransactionEntrypointHash: { Atom: lib.Variant<'TransactionEntrypointHash', lib.VariantUnit<'Atom'>> }, TransactionEntrypoint: { Atom: lib.Variant<'TransactionEntrypoint', lib.VariantUnit<'Atom'>>, Authority: { Atom: lib.Variant<'TransactionEntrypoint', lib.Variant<'Authority', lib.VariantUnit<'Atom'>>>, Domain: { Atom: lib.Variant<'TransactionEntrypoint', lib.Variant<'Authority', lib.Variant<'Domain', lib.VariantUnit<'Atom'>>>>, Name: { Atom: lib.Variant<'TransactionEntrypoint', lib.Variant<'Authority', lib.Variant<'Domain', lib.Variant<'Name', lib.VariantUnit<'Atom'>>>>> } }, Signatory: { Atom: lib.Variant<'TransactionEntrypoint', lib.Variant<'Authority', lib.Variant<'Signatory', lib.VariantUnit<'Atom'>>>> } } }, TransactionResultHash: { Atom: lib.Variant<'TransactionResultHash', lib.VariantUnit<'Atom'>> }, TransactionResult: { Atom: lib.Variant<'TransactionResult', lib.VariantUnit<'Atom'>> } } = { ...{ Atom: Object.freeze({ kind: 'Atom' }), BlockHash: { Atom: Object.freeze<lib.Variant<'BlockHash', lib.VariantUnit<'Atom'>>>({ kind: 'BlockHash', value: BlockHeaderHashProjectionSelector.Atom }) }, TransactionEntrypointHash: { Atom: Object.freeze<lib.Variant<'TransactionEntrypointHash', lib.VariantUnit<'Atom'>>>({ kind: 'TransactionEntrypointHash', value: TransactionEntrypointHashProjectionSelector.Atom }) }, TransactionEntrypoint: { Atom: Object.freeze<lib.Variant<'TransactionEntrypoint', lib.VariantUnit<'Atom'>>>({ kind: 'TransactionEntrypoint', value: TransactionEntrypointProjectionSelector.Atom }), Authority: { Atom: Object.freeze<lib.Variant<'TransactionEntrypoint', lib.Variant<'Authority', lib.VariantUnit<'Atom'>>>>({ kind: 'TransactionEntrypoint', value: TransactionEntrypointProjectionSelector.Authority.Atom }), Domain: { Atom: Object.freeze<lib.Variant<'TransactionEntrypoint', lib.Variant<'Authority', lib.Variant<'Domain', lib.VariantUnit<'Atom'>>>>>({ kind: 'TransactionEntrypoint', value: TransactionEntrypointProjectionSelector.Authority.Domain.Atom }), Name: { Atom: Object.freeze<lib.Variant<'TransactionEntrypoint', lib.Variant<'Authority', lib.Variant<'Domain', lib.Variant<'Name', lib.VariantUnit<'Atom'>>>>>>({ kind: 'TransactionEntrypoint', value: TransactionEntrypointProjectionSelector.Authority.Domain.Name.Atom }) } }, Signatory: { Atom: Object.freeze<lib.Variant<'TransactionEntrypoint', lib.Variant<'Authority', lib.Variant<'Signatory', lib.VariantUnit<'Atom'>>>>>({ kind: 'TransactionEntrypoint', value: TransactionEntrypointProjectionSelector.Authority.Signatory.Atom }) } } }, TransactionResultHash: { Atom: Object.freeze<lib.Variant<'TransactionResultHash', lib.VariantUnit<'Atom'>>>({ kind: 'TransactionResultHash', value: TransactionResultHashProjectionSelector.Atom }) }, TransactionResult: { Atom: Object.freeze<lib.Variant<'TransactionResult', lib.VariantUnit<'Atom'>>>({ kind: 'TransactionResult', value: TransactionResultProjectionSelector.Atom }) } }, ...lib.defineCodec(lib.enumCodec<{ Atom: [], BlockHash: [BlockHeaderHashProjectionSelector], TransactionEntrypointHash: [TransactionEntrypointHashProjectionSelector], TransactionEntrypoint: [TransactionEntrypointProjectionSelector], TransactionResultHash: [TransactionResultHashProjectionSelector], TransactionResult: [TransactionResultProjectionSelector] }>({ Atom: [0], BlockHash: [1, lib.getCodec(BlockHeaderHashProjectionSelector)], TransactionEntrypointHash: [2, lib.getCodec(TransactionEntrypointHashProjectionSelector)], TransactionEntrypoint: [3, lib.getCodec(TransactionEntrypointProjectionSelector)], TransactionResultHash: [4, lib.getCodec(TransactionResultHashProjectionSelector)], TransactionResult: [5, lib.getCodec(TransactionResultProjectionSelector)] }).discriminated()) }
 ...
 * TODO how to construct, how to use
 */
export type SmartContractParameter = lib.Variant<'Fuel', lib.NonZero<lib.U64>> | lib.Variant<'Memory', lib.NonZero<lib.U64>> | lib.Variant<'ExecutionDepth', lib.U8>
/**
 * Codec and constructors for enumeration {@link SmartContractParameter}.
 */
export const SmartContractParameter: lib.CodecContainer<SmartContractParameter> & { Fuel: <const T extends lib.NonZero<lib.U64>>(value: T) => lib.Variant<'Fuel', T>, Memory: <const T extends lib.NonZero<lib.U64>>(value: T) => lib.Variant<'Memory', T>, ExecutionDepth: <const T extends lib.U8>(value: T) => lib.Variant<'ExecutionDepth', T> } = { ...{ Fuel: <const T extends lib.NonZero<lib.U64>>(value: T): lib.Variant<'Fuel', T> => ({ kind: 'Fuel', value }), Memory: <const T extends lib.NonZero<lib.U64>>(value: T): lib.Variant<'Memory', T> => ({ kind: 'Memory', value }), ExecutionDepth: <const T extends lib.U8>(value: T): lib.Variant<'ExecutionDepth', T> => ({ kind: 'ExecutionDepth', value }) }, ...lib.defineCodec(lib.enumCodec<{ Fuel: [lib.NonZero<lib.U64>], Memory: [lib.NonZero<lib.U64>], ExecutionDepth: [lib.U8] }>({ Fuel: [0, lib.NonZero.with(lib.getCodec(lib.U64))], Memory: [1, lib.NonZero.with(lib.getCodec(lib.U64))], ExecutionDepth: [2, lib.getCodec(lib.U8)] }).discriminated()) }
 ...
 */
export const Parameter: lib.CodecContainer<Parameter> & { Sumeragi: { BlockTime: <const T extends lib.Duration>(value: T) => lib.Variant<'Sumeragi', lib.Variant<'BlockTime', T>>, CommitTime: <const T extends lib.Duration>(value: T) => lib.Variant<'Sumeragi', lib.Variant<'CommitTime', T>>, MaxClockDrift: <const T extends lib.Duration>(value: T) => lib.Variant<'Sumeragi', lib.Variant<'MaxClockDrift', T>> }, Block: { MaxTransactions: <const T extends lib.NonZero<lib.U64>>(value: T) => lib.Variant<'Block', lib.Variant<'MaxTransactions', T>> }, Transaction: { MaxInstructions: <const T extends lib.NonZero<lib.U64>>(value: T) => lib.Variant<'Transaction', lib.Variant<'MaxInstructions', T>>, SmartContractSize: <const T extends lib.NonZero<lib.U64>>(value: T) => lib.Variant<'Transaction', lib.Variant<'SmartContractSize', T>> }, SmartContract: { Fuel: <const T extends lib.NonZero<lib.U64>>(value: T) => lib.Variant<'SmartContract', lib.Variant<'Fuel', T>>, Memory: <const T extends lib.NonZero<lib.U64>>(value: T) => lib.Variant<'SmartContract', lib.Variant<'Memory', T>>, ExecutionDepth: <const T extends lib.U8>(value: T) => lib.Variant<'SmartContract', lib.Variant<'ExecutionDepth', T>> }, Executor: { Fuel: <const T extends lib.NonZero<lib.U64>>(value: T) => lib.Variant<'Executor', lib.Variant<'Fuel', T>>, Memory: <const T extends lib.NonZero<lib.U64>>(value: T) => lib.Variant<'Executor', lib.Variant<'Memory', T>>, ExecutionDepth: <const T extends lib.U8>(value: T) => lib.Variant<'Executor', lib.Variant<'ExecutionDepth', T>> }, Custom: <const T extends CustomParameter>(value: T) => lib.Variant<'Custom', T> } = { ...{ Sumeragi: { BlockTime: <const T extends lib.Duration>(value: T): lib.Variant<'Sumeragi', lib.Variant<'BlockTime', T>> => ({ kind: 'Sumeragi', value: SumeragiParameter.BlockTime(value) }), CommitTime: <const T extends lib.Duration>(value: T): lib.Variant<'Sumeragi', lib.Variant<'CommitTime', T>> => ({ kind: 'Sumeragi', value: SumeragiParameter.CommitTime(value) }), MaxClockDrift: <const T extends lib.Duration>(value: T): lib.Variant<'Sumeragi', lib.Variant<'MaxClockDrift', T>> => ({ kind: 'Sumeragi', value: SumeragiParameter.MaxClockDrift(value) }) }, Block: { MaxTransactions: <const T extends lib.NonZero<lib.U64>>(value: T): lib.Variant<'Block', lib.Variant<'MaxTransactions', T>> => ({ kind: 'Block', value: BlockParameter.MaxTransactions(value) }) }, Transaction: { MaxInstructions: <const T extends lib.NonZero<lib.U64>>(value: T): lib.Variant<'Transaction', lib.Variant<'MaxInstructions', T>> => ({ kind: 'Transaction', value: TransactionParameter.MaxInstructions(value) }), SmartContractSize: <const T extends lib.NonZero<lib.U64>>(value: T): lib.Variant<'Transaction', lib.Variant<'SmartContractSize', T>> => ({ kind: 'Transaction', value: TransactionParameter.SmartContractSize(value) }) }, SmartContract: { Fuel: <const T extends lib.NonZero<lib.U64>>(value: T): lib.Variant<'SmartContract', lib.Variant<'Fuel', T>> => ({ kind: 'SmartContract', value: SmartContractParameter.Fuel(value) }), Memory: <const T extends lib.NonZero<lib.U64>>(value: T): lib.Variant<'SmartContract', lib.Variant<'Memory', T>> => ({ kind: 'SmartContract', value: SmartContractParameter.Memory(value) }), ExecutionDepth: <const T extends lib.U8>(value: T): lib.Variant<'SmartContract', lib.Variant<'ExecutionDepth', T>> => ({ kind: 'SmartContract', value: SmartContractParameter.ExecutionDepth(value) }) }, Executor: { Fuel: <const T extends lib.NonZero<lib.U64>>(value: T): lib.Variant<'Executor', lib.Variant<'Fuel', T>> => ({ kind: 'Executor', value: SmartContractParameter.Fuel(value) }), Memory: <const T extends lib.NonZero<lib.U64>>(value: T): lib.Variant<'Executor', lib.Variant<'Memory', T>> => ({ kind: 'Executor', value: SmartContractParameter.Memory(value) }), ExecutionDepth: <const T extends lib.U8>(value: T): lib.Variant<'Executor', lib.Variant<'ExecutionDepth', T>> => ({ kind: 'Executor', value: SmartContractParameter.ExecutionDepth(value) }) }, Custom: <const T extends CustomParameter>(value: T): lib.Variant<'Custom', T> => ({ kind: 'Custom', value }) }, ...lib.defineCodec(lib.enumCodec<{ Sumeragi: [SumeragiParameter], Block: [BlockParameter], Transaction: [TransactionParameter], SmartContract: [SmartContractParameter], Executor: [SmartContractParameter], Custom: [CustomParameter] }>({ Sumeragi: [0, lib.getCodec(SumeragiParameter)], Block: [1, lib.getCodec(BlockParameter)], Transaction: [2, lib.getCodec(TransactionParameter)], SmartContract: [3, lib.getCodec(SmartContractParameter)], Executor: [4, lib.getCodec(SmartContractParameter)], Custom: [5, lib.getCodec(CustomParameter)] }).discriminated()) }
 ...
 * TODO how to construct, how to use
 */
export type Order = lib.VariantUnit<'Ascending'> | lib.VariantUnit<'Descending'>
/**
 * Codec and constructors for enumeration {@link Order}.
 */
export const Order: lib.CodecContainer<Order> & { Ascending: lib.VariantUnit<'Ascending'>, Descending: lib.VariantUnit<'Descending'> } = { ...{ Ascending: Object.freeze({ kind: 'Ascending' }), Descending: Object.freeze({ kind: 'Descending' }) }, ...lib.defineCodec(lib.enumCodec<{ Ascending: [], Descending: [] }>({ Ascending: [0], Descending: [1] }).discriminated()) }

/**
 * Structure with named fields.
 */
export interface FindBlockHeaders { order: Order }
/**
 * Codec of the structure.
 */
export const FindBlockHeaders: lib.CodecContainer<FindBlockHeaders> = lib.defineCodec(lib.structCodec<FindBlockHeaders>(['order'], {order: lib.getCodec(Order)}))

/**
 * Structure with named fields.
 */
export interface FindBlocks { order: Order }
/**
 * Codec of the structure.
 */
export const FindBlocks: lib.CodecContainer<FindBlocks> = lib.defineCodec(lib.structCodec<FindBlocks>(['order'], {order: lib.getCodec(Order)}))
 ...
 * Structure with named fields.
 */
export interface SmartContractParameters { fuel: lib.NonZero<lib.U64>, memory: lib.NonZero<lib.U64>, executionDepth: lib.U8 }
/**
 * Codec of the structure.
 */
export const SmartContractParameters: lib.CodecContainer<SmartContractParameters> = lib.defineCodec(lib.structCodec<SmartContractParameters>(['fuel', 'memory', 'executionDepth'], {fuel: lib.NonZero.with(lib.getCodec(lib.U64)), memory: lib.NonZero.with(lib.getCodec(lib.U64)), executionDepth: lib.getCodec(lib.U8)}))
 ...
 * Structure with named fields.
 */
export interface Status { peers: lib.Compact, blocks: lib.Compact, blocksNonEmpty: lib.Compact, commitTime: lib.DurationCompact, txsApproved: lib.Compact, txsRejected: lib.Compact, uptime: Uptime, viewChanges: lib.Compact, queueSize: lib.Compact }
/**
 * Codec of the structure.
 */
export const Status: lib.CodecContainer<Status> = lib.defineCodec(lib.structCodec<Status>(['peers', 'blocks', 'blocksNonEmpty', 'commitTime', 'txsApproved', 'txsRejected', 'uptime', 'viewChanges', 'queueSize'], {peers: lib.getCodec(lib.Compact), blocks: lib.getCodec(lib.Compact), blocksNonEmpty: lib.getCodec(lib.Compact), commitTime: lib.getCodec(lib.DurationCompact), txsApproved: lib.getCodec(lib.Compact), txsRejected: lib.getCodec(lib.Compact), uptime: lib.getCodec(Uptime), viewChanges: lib.getCodec(lib.Compact), queueSize: lib.getCodec(lib.Compact)}))