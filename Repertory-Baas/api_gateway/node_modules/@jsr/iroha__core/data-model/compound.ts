...
import type { JsonValue } from 'npm:type-fest@^4.33.0'
import { enumCodec, type GenCodec, getCodec, lazyCodec, structCodec, SYMBOL_CODEC } from '../codec.js'
import { type IsZero, type Ord, ordCompare } from '../traits.js'
