...
import { unreachable } from '@jsr/std__assert'
import * as scale from '@scale-codec/core'
import { enumCodec, type EnumCodecSchema, GenCodec, nullCodec, structCodec, tupleCodec } from './codec.js'
import * as dm from './data-model/mod.js'
import SCHEMA from './data-model/schema/json.js'
import type { SchemaTypeDefinition } from './data-model/schema/mod.ts'
import { getCodec } from './data-model/prototypes.generated.prelude.js'
