 ...
 */ export const TriggerExecutionFail = {
  ...{
    MaxDepthExceeded: Object.freeze({
 ...
 */ export const TransactionRejectionReason = {
  ...{
    ...
    TriggerExecution: {
      MaxDepthExceeded: Object.freeze({
        kind: 'TriggerExecution',
        value: TriggerExecutionFail.MaxDepthExceeded
      })
    }
  },
  ...lib.defineCodec(lib.enumCodec({
    ...
    TriggerExecution: [
      5,
      lib.getCodec(TriggerExecutionFail)
    ]
  }).discriminated())
};
/**
  ...
  ...{
    ...
    Rejected: {
      ...
      TriggerExecution: {
        MaxDepthExceeded: Object.freeze({
          kind: 'Rejected',
          value: TransactionRejectionReason.TriggerExecution.MaxDepthExceeded
        })
      }
    }
  },
 ...
 */ export const BlockHeader = lib.defineCodec(lib.structCodec([
  ...
  merkleRoot: lib.Option.with(lib.getCodec(lib.Hash)),
  resultMerkleRoot: lib.Option.with(lib.getCodec(lib.Hash)),
...
export const ExecutionStep = lib.defineCodec(lib.Vec.with(lib.lazyCodec(()=>lib.getCodec(InstructionBox))));
/**
 * Codec of the structure.
 */ export const TimeTriggerEntrypoint = lib.defineCodec(lib.structCodec([
  'id',
  'instructions',
  'authority'
], {
  id: lib.getCodec(TriggerId),
  instructions: lib.getCodec(ExecutionStep),
  authority: lib.getCodec(lib.AccountId)
}));
export const MerkleTree = lib.defineCodec(lib.Vec.with(lib.Option.with(lib.getCodec(lib.Hash))));
/**
 * Codec of the structure.
 */ export const DataTriggerStep = lib.defineCodec(lib.structCodec([
  'id',
  'instructions'
], {
  id: lib.getCodec(TriggerId),
 ...
 */ export const TransactionResult = {
  ...
  ...lib.defineCodec(lib.enumCodec({
    Ok: [
      0,
      lib.Vec.with(lib.getCodec(DataTriggerStep))
    ],
    Err: [
      1,
      lib.getCodec(TransactionRejectionReason)
...
/**
 * Codec of the structure.
 */ export const BlockResult = lib.defineCodec(lib.structCodec([
  'timeTriggers',
  'merkle',
  'resultMerkle',
  'transactionResults'
], {
  timeTriggers: lib.Vec.with(lib.getCodec(TimeTriggerEntrypoint)),
  merkle: lib.getCodec(MerkleTree),
  resultMerkle: lib.getCodec(MerkleTree),
  transactionResults: lib.Vec.with(lib.getCodec(TransactionResult))
}));
/**
 * Codec of the structure.
 ...
 */ export const SignedBlockV1 = lib.defineCodec(lib.structCodec([
  ...
  signatures: lib.BTreeSet.with(lib.getCodec(lib.BlockSignature)),
  payload: lib.getCodec(BlockPayload),
  result: lib.getCodec(BlockResult)
}));
/**
 ...
 */ export const BlockStreamMessage = {
  ...{
    Subscribe: (value)=>({
        kind: 'Subscribe',
        value
  ...
  ...lib.defineCodec(lib.enumCodec({
    Subscribe: [
      0,
      lib.getCodec(BlockSubscriptionRequest)
    ],
    Next: [
      1
    ],
...
/**
 * Codec of the structure.
 */ export const MerkleProof = lib.defineCodec(lib.structCodec([
  'leafIndex',
  'auditPath'
], {
  leafIndex: lib.getCodec(lib.U32),
  auditPath: lib.Vec.with(lib.Option.with(lib.getCodec(lib.Hash)))
}));
/**
 * Codec and constructors for enumeration {@link TransactionEntrypoint}.
 */ export const TransactionEntrypoint = {
  ...{
    External: {
      V1: (value)=>({
          kind: 'External',
          value: SignedTransaction.V1(value)
        })
    },
    Time: (value)=>({
        kind: 'Time',
  ...
  ...lib.defineCodec(lib.enumCodec({
    External: [
      0,
      lib.getCodec(SignedTransaction)
    ],
    Time: [
      1,
      lib.getCodec(TimeTriggerEntrypoint)
    ]
  }).discriminated())
};
/**
 ...
 */ export const CommittedTransaction = lib.defineCodec(lib.structCodec([
  ...
  entrypointHash: lib.getCodec(lib.Hash),
  entrypointProof: lib.getCodec(MerkleProof),
  entrypoint: lib.getCodec(TransactionEntrypoint),
  resultHash: lib.getCodec(lib.Hash),
  resultProof: lib.getCodec(MerkleProof),
  result: lib.getCodec(TransactionResult)
}));
/**
 ...
 */ export const TransactionEntrypointHashProjectionPredicate = {
  ...{
    Atom: {
      Equals: (value)=>({
          kind: 'Atom',
          value: TransactionEntrypointHashPredicateAtom.Equals(value)
        })
    }
  },
  ...lib.defineCodec(lib.enumCodec({
    Atom: [
      0,
      lib.getCodec(TransactionEntrypointHashPredicateAtom)
    ]
  }).discriminated())
};
/**
 * Codec and constructors for enumeration {@link TransactionEntrypointPredicateAtom}.
 */ export const TransactionEntrypointPredicateAtom = {
  ...{
    IsExternal: Object.freeze({
      kind: 'IsExternal'
    })
  },
  ...lib.defineCodec(lib.enumCodec({
 ...
 */ export const TransactionEntrypointProjectionPredicate = {
  ...{
    Atom: {
      IsExternal: Object.freeze({
        kind: 'Atom',
        value: TransactionEntrypointPredicateAtom.IsExternal
      })
    },
    Authority: {
      Atom: {
  ...
  ...lib.defineCodec(lib.enumCodec({
    Atom: [
      0,
      lib.getCodec(TransactionEntrypointPredicateAtom)
    ],
    Authority: [
      1,
      lib.getCodec(AccountIdProjectionPredicate)
 ...
 */ export const TransactionResultHashPredicateAtom = {
  ...{
    Equals: (value)=>({
        kind: 'Equals',
        value
 ...
 */ export const TransactionResultHashProjectionPredicate = {
  ...{
    Atom: {
      Equals: (value)=>({
          kind: 'Atom',
          value: TransactionResultHashPredicateAtom.Equals(value)
        })
    }
  },
  ...lib.defineCodec(lib.enumCodec({
    Atom: [
      0,
      lib.getCodec(TransactionResultHashPredicateAtom)
    ]
  }).discriminated())
};
/**
 * Codec and constructors for enumeration {@link TransactionResultPredicateAtom}.
 */ export const TransactionResultPredicateAtom = {
  ...{
    IsOk: Object.freeze({
      kind: 'IsOk'
    }),
    ContainsDataTrigger: (value)=>({
        kind: 'ContainsDataTrigger',
        value
      })
  },
  ...lib.defineCodec(lib.enumCodec({
 ...
 */ export const TransactionResultProjectionPredicate = {
  ...{
    Atom: {
      IsOk: Object.freeze({
        kind: 'Atom',
        value: TransactionResultPredicateAtom.IsOk
      }),
      ContainsDataTrigger: (value)=>({
          kind: 'Atom',
          value: TransactionResultPredicateAtom.ContainsDataTrigger(value)
        })
    }
  },
  ...lib.defineCodec(lib.enumCodec({
    Atom: [
      0,
      lib.getCodec(TransactionResultPredicateAtom)
    ]
  }).discriminated())
};
/**
 ...
 */ export const CommittedTransactionProjectionPredicate = {
  ...{
    ...
    TransactionEntrypointHash: {
      Atom: {
        Equals: (value)=>({
            kind: 'TransactionEntrypointHash',
            value: TransactionEntrypointHashProjectionPredicate.Atom.Equals(value)
          })
      }
    },
    TransactionEntrypoint: {
      Atom: {
        IsExternal: Object.freeze({
          kind: 'TransactionEntrypoint',
          value: TransactionEntrypointProjectionPredicate.Atom.IsExternal
        })
      },
      Authority: {
        Atom: {
          Equals: (value)=>({
              kind: 'TransactionEntrypoint',
              value: TransactionEntrypointProjectionPredicate.Authority.Atom.Equals(value)
            })
        },
        Domain: {
          Atom: {
            Equals: (value)=>({
                kind: 'TransactionEntrypoint',
                value: TransactionEntrypointProjectionPredicate.Authority.Domain.Atom.Equals(value)
              })
          },
          Name: {
            Atom: {
              Equals: (value)=>({
                  kind: 'TransactionEntrypoint',
                  value: TransactionEntrypointProjectionPredicate.Authority.Domain.Name.Atom.Equals(value)
                }),
              Contains: (value)=>({
                  kind: 'TransactionEntrypoint',
                  value: TransactionEntrypointProjectionPredicate.Authority.Domain.Name.Atom.Contains(value)
                }),
              StartsWith: (value)=>({
                  kind: 'TransactionEntrypoint',
                  value: TransactionEntrypointProjectionPredicate.Authority.Domain.Name.Atom.StartsWith(value)
                }),
              EndsWith: (value)=>({
                  kind: 'TransactionEntrypoint',
                  value: TransactionEntrypointProjectionPredicate.Authority.Domain.Name.Atom.EndsWith(value)
                })
            }
          }
        },
        Signatory: {
          Atom: {
            Equals: (value)=>({
                kind: 'TransactionEntrypoint',
                value: TransactionEntrypointProjectionPredicate.Authority.Signatory.Atom.Equals(value)
              })
          }
        }
      }
    ...
    TransactionResultHash: {
      Atom: {
        Equals: (value)=>({
            kind: 'TransactionResultHash',
            value: TransactionResultHashProjectionPredicate.Atom.Equals(value)
          })
      }
    },
    TransactionResult: {
      Atom: {
        IsOk: Object.freeze({
          ...
          value: TransactionResultProjectionPredicate.Atom.IsOk
        }),
        ContainsDataTrigger: (value)=>({
            kind: 'TransactionResult',
            value: TransactionResultProjectionPredicate.Atom.ContainsDataTrigger(value)
          })
      }
    }
  },
  ...lib.defineCodec(lib.enumCodec({
    ...
    TransactionEntrypointHash: [
      2,
      lib.getCodec(TransactionEntrypointHashProjectionPredicate)
    ],
    TransactionEntrypoint: [
      3,
      lib.getCodec(TransactionEntrypointProjectionPredicate)
    ],
    TransactionResultHash: [
      4,
      lib.getCodec(TransactionResultHashProjectionPredicate)
    ],
    TransactionResult: [
      5,
      lib.getCodec(TransactionResultProjectionPredicate)
    ]
  }).discriminated())
};
/**
 * Codec and constructors for enumeration {@link TransactionEntrypointHashProjectionSelector}.
 */ export const TransactionEntrypointHashProjectionSelector = {
  ...{
    Atom: Object.freeze({
      kind: 'Atom'
    })
 ...
 */ export const TransactionEntrypointProjectionSelector = {
  ...{
    Atom: Object.freeze({
      kind: 'Atom'
    }),
 ...
 */ export const TransactionResultHashProjectionSelector = {
  ...{
    Atom: Object.freeze({
      kind: 'Atom'
    })
 ...
 */ export const TransactionResultProjectionSelector = {
  ...{
    Atom: Object.freeze({
      kind: 'Atom'
    })
 ...
 */ export const CommittedTransactionProjectionSelector = {
  ...{
    ...
    TransactionEntrypointHash: {
      Atom: Object.freeze({
        kind: 'TransactionEntrypointHash',
        value: TransactionEntrypointHashProjectionSelector.Atom
      })
    },
    TransactionEntrypoint: {
      Atom: Object.freeze({
        kind: 'TransactionEntrypoint',
        value: TransactionEntrypointProjectionSelector.Atom
      }),
      Authority: {
        Atom: Object.freeze({
          kind: 'TransactionEntrypoint',
          value: TransactionEntrypointProjectionSelector.Authority.Atom
        }),
        Domain: {
          Atom: Object.freeze({
            kind: 'TransactionEntrypoint',
            value: TransactionEntrypointProjectionSelector.Authority.Domain.Atom
          }),
          Name: {
            Atom: Object.freeze({
              kind: 'TransactionEntrypoint',
              value: TransactionEntrypointProjectionSelector.Authority.Domain.Name.Atom
            })
          }
        },
        Signatory: {
          Atom: Object.freeze({
            kind: 'TransactionEntrypoint',
            value: TransactionEntrypointProjectionSelector.Authority.Signatory.Atom
          })
        }
      }
    },
    TransactionResultHash: {
      Atom: Object.freeze({
        kind: 'TransactionResultHash',
        value: TransactionResultHashProjectionSelector.Atom
      })
    },
    TransactionResult: {
      Atom: Object.freeze({
        kind: 'TransactionResult',
        value: TransactionResultProjectionSelector.Atom
      })
    }
  },
  ...lib.defineCodec(lib.enumCodec({
    ...
    TransactionEntrypointHash: [
      2,
      lib.getCodec(TransactionEntrypointHashProjectionSelector)
    ],
    TransactionEntrypoint: [
      3,
      lib.getCodec(TransactionEntrypointProjectionSelector)
    ],
    TransactionResultHash: [
      4,
      lib.getCodec(TransactionResultHashProjectionSelector)
    ],
    TransactionResult: [
      5,
      lib.getCodec(TransactionResultProjectionSelector)
    ]
  }).discriminated())
};
/**
 ...
 */ export const Parameter = {
  ...{
    ...
    SmartContract: {
      ...
      ExecutionDepth: (value)=>({
          kind: 'SmartContract',
          value: SmartContractParameter.ExecutionDepth(value)
        })
    },
    Executor: {
      Fuel: (value)=>({
...
/**
 * Codec of the structure.
 */ export const FindBlockHeaders = lib.defineCodec(lib.structCodec([
  'order'
], {
  order: lib.getCodec(Order)
}));
/**
 * Codec of the structure.
 */ export const FindBlocks = lib.defineCodec(lib.structCodec([
  'order'
], {
  order: lib.getCodec(Order)
}));
  ...
  ...{
    ...
    SetParameter: {
      ...
      SmartContract: {
        ...
        ExecutionDepth: (value)=>({
            kind: 'SetParameter',
            value: SetParameter.SmartContract.ExecutionDepth(value)
          })
      },
      Executor: {
        Fuel: (value)=>({
        ...
        ExecutionDepth: (value)=>({
            kind: 'SetParameter',
            value: SetParameter.Executor.ExecutionDepth(value)
          })
      },
      Custom: (value)=>({
          kind: 'SetParameter',
 ...
 */ export const SmartContractParameters = lib.defineCodec(lib.structCodec([
  ...
  executionDepth: lib.getCodec(lib.U8)
}));
/**
 * Codec of the structure.
 ...
 */ export const QueryBox = {
  ...
  ...lib.defineCodec(lib.enumCodec({
    ...
    FindBlocks: [
      14,
      QueryWithFilter.with(lib.getCodec(FindBlocks), lib.CompoundPredicate.with(lib.getCodec(SignedBlockProjectionPredicate)), lib.Vec.with(lib.getCodec(SignedBlockProjectionSelector)))
    ],
    FindBlockHeaders: [
      15,
      QueryWithFilter.with(lib.getCodec(FindBlockHeaders), lib.CompoundPredicate.with(lib.getCodec(BlockHeaderProjectionPredicate)), lib.Vec.with(lib.getCodec(BlockHeaderProjectionSelector)))
    ]
  }).discriminated())
};
/**
 ...
 */ export const QueryOutputBatchBox = {
  ...{
    ...
    TransactionEntrypointHash: (value)=>({
        kind: 'TransactionEntrypointHash',
        value
      }),
    Peer: (value)=>({
  ...
  ...lib.defineCodec(lib.enumCodec({
    ...
    TransactionResult: [
      20,
      lib.Vec.with(lib.getCodec(TransactionResult))
    ],
    TransactionResultHash: [
      21,
    ...
    TransactionEntrypoint: [
      22,
      lib.Vec.with(lib.getCodec(TransactionEntrypoint))
    ],
    TransactionEntrypointHash: [
      23,
      lib.Vec.with(lib.getCodec(lib.Hash))
 ...
 */ export const Status = lib.defineCodec(lib.structCodec([
  ...
  commitTime: lib.getCodec(lib.DurationCompact),
