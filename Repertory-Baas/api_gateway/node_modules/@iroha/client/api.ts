...
import { getCodec, type Variant, type VariantUnit } from '@jsr/iroha__core'
import * as dm from '@jsr/iroha__core/data-model'
import type { Schema as DataModelSchema } from 'jsr:@iroha/core@^0.5.0-alpha/data-model/schema'
import {
  CONTENT_TYPE_SCALE,
...
import type { PartialDeep } from 'npm:type-fest@^4.33.0'
